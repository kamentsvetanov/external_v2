...
HDBIG-SR (being the collection of files) is free but copyright software,
...
In particular, KG-SCCA and its documentation are provided as is and  
...
HDBIG-SR has not been evaluated by or approved by the United States Food and 
Drug Administration (FDA), or by any other agency.  
There are no plans to have this software so evaluated.

KG-SCCA was written by members and collaborators of the
...
The HDBIG-SR web site is the central repository for all resources:
     http://www.iu.edu/~hdbig/SCCA
Introductory material, documentation, and patches are published on the site.

Please report bugs to the authors at <hdbig@iu.edu>. News on patches 
