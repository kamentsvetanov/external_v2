...
% be in the center of the image box. Note: another function may be needed
% for the non-axially acquired image especially when it was converted into
% Nifti format using non-SPM software. Display the image to check that.
% Ze Wang. All rights reserved. Upenn
function ASLtbx_resetimgorgASL(P)
