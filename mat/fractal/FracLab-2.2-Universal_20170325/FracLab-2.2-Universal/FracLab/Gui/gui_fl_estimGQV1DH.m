...
a = figure( 'Name','GQV based estimation 1D','Tag','Fig_gui_fl_estimGQV1DH',...
...
uicontrol('Parent',a,'Style','text','Tag','StaticText_title', ...
    ...
    'String','Estimation of Holder exponent - GQV based method 1D');
...
uicontrol('Parent',a,'Tag','Button_refresh', ...
    ...
    'String','Refresh', ...
    'Callback','fl_estimGQV1DH_compute(''refresh'')');
...
uicontrol('Parent',a,'Style','radiobutton','Tag','RadioButton_linear', ...
    ...
    'String','Linear', ...
    'Value',1, ...
    'Callback','fl_estimGQV1DH_compute(''linear_option'')');
...
uicontrol('Parent',a,'Style','radiobutton','Tag','RadioButton_geometric', ...
    ...
    'String','Geometric', ...
    'Value',0, ...
    'Callback','fl_estimGQV1DH_compute(''geometric_option'')');
...
uicontrol('Parent',a,'Style','edit','Tag','EditText_zones', ...
    ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String','10', ...
    'Callback','fl_estimGQV1DH_compute(''edit_zones'')');
...
uicontrol('Parent',a,'Style','edit','Tag','EditText_step', ...
    ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String','1', ...
    'Callback','fl_estimGQV1DH_compute(''edit_step'')');
...
uicontrol('Parent',a,'Style','Checkbox','Tag','Check_timeinstant', ...
    ...
    'Value',1, ...
    'Callback','fl_estimGQV1DH_compute(''check_time'')');
...
uicontrol('Parent',a,'Style','edit','Tag','EditText_timeinstant', ...
    ...
    'Enable','off', ...
    'Callback','fl_estimGQV1DH_compute(''edit_time'')');
...
uicontrol('Parent',a,'Style','Checkbox','Tag','Check_regression', ...
    ...
    'String','Regression', ...
    'Value',1, ...
    'Callback','fl_estimGQV1DH_compute(''check_regression'')');
...
uicontrol('Parent',a,'Style','popupmenu','Tag','Regtype_menu', ...
    ...
    'Value',1, ...
    'Callback','fl_estimGQV1DH_compute(''regtype'')');
...
fl_estimGQV1DH_compute('refresh');
