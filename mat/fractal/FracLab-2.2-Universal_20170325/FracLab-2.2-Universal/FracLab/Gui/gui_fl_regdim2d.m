...
a = figure('Name','Reg Dimension - 2D','Tag','Fig_gui_fl_regdim2d', ...
...
uicontrol('Parent',a,'Style','text','Tag','StaticText_title', ...
	...
	'String','Regularization Dimension - 2D');
...
uicontrol('Parent',a,'Tag','Button_refresh', ...
    ...
    'String','Refresh', ...
    'Callback','fl_regdim2d_compute(''refresh'');');
...
uicontrol('Parent',a,'Style','edit','Tag','EditText_nmax', ...
	...
	'FontUnits','normalized','FontSize',0.6, ...
	'Callback','fl_regdim2d_compute(''edit_nmax'');', ...
	'String','64');

uicontrol('Parent',a,'Style','popupmenu','Tag','PopupMenu_nmax', ...
	'Units','normalized','Position',[0.79 0.65 0.15 0.07], ...
	'FontUnits','normalized','FontSize',0.6, ...
	'Callback','fl_regdim2d_compute(''popmenu_nmax'');', ...
	'String',{'16', '32', '64', '128', '256'}, ...
	'Value',3);
...
uicontrol('Parent',a,'Style','edit','Tag','EditText_noise', ...
	...
	'FontUnits','normalized','FontSize',0.6, ...
	'Callback','fl_regdim2d_compute(''edit_sigma'');', ...
	'String','0');
...
uicontrol('Parent',a,'Style','Checkbox','Tag','Check_regularized', ...
    ...
    'Value',0, ...
    'Callback','fl_regdim2d_compute(''check_reg'');');

uicontrol('Parent',a,'Style','Checkbox','Tag','Check_savereg', ...
	'Units','normalized','Position',[0.5 0.26 0.46 0.07], ...
	'FontUnits','normalized','FontSize',0.6, ...
	'String','Save regularized graphs','Enable','off', ...
	'Value',0, ...
    'Callback','fl_regdim2d_compute(''check_savereg'');');

%%%%%%%%%%%%%%%%%%%% COMPUTE/HELP/CLOSE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
uicontrol('Parent',a,'Tag','Button_compute', ...
	'Units','normalized','Position',[0.032 0.12 0.2 0.11], ...
	'FontUnits','normalized','FontWeight','bold','FontSize',0.4, ...
    'String','Compute', ...
	'Callback','eval([''global '' fl_regdim2d_compute(''compute'',who)])');

uicontrol('Parent',a,'Tag','Button_help', ...
	'Units','normalized','Position',[0.41 0.12 0.2 0.11], ...
	'FontUnits','normalized','FontWeight','bold','FontSize',0.4, ...
    'String','Help', ...
	'Callback','fl_regdim2d_compute(''help'');');

uicontrol('Parent',a,'Tag','Button_close', ...
	'Units','normalized','Position',[0.77 0.12 0.2 0.11], ...
	'FontUnits','normalized','FontWeight','bold','FontSize',0.4, ...
	'String','Close', ...
	'Callback','fl_regdim2d_compute(''close'');');
