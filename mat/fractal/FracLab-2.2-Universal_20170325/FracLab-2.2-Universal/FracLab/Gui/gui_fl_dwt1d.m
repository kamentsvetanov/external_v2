...
a = figure( 'Name','Discrete Wavelet Transform 1D','Tag','Fig_gui_fl_dwt1d',...
...
uicontrol('Parent',a,'Style','text','Tag','StaticText_title', ...
	...
	'String','Discrete Wavelet Transform 1D');
...
uicontrol('Parent',a,'Tag','Button_refresh', ...
	...
	'String','Refresh', ...
    'Callback','fl_dwt1d_compute(''refresh'')');
...
uicontrol('Parent',a,'Style','edit','Tag','EditText_octaves', ...
	...
	'FontUnits','normalized','FontSize',0.6, ...
	'String','10', ...
    'Callback','fl_dwt1d_compute(''edit_octaves'')');
