function fig = gui_fl_mmssynthesis()
...
a = figure( 'Name','mms Synthesis 1D','Tag','Fig_gui_fl_mmssynthesis',...
...
uicontrol('Parent',a,'Style','frame','Tag','Frame_size_input', ...
    'Units','normalized','Position',[0.049 0.16 0.919 0.7]);
...
uicontrol('Parent',a,'Style','text','Tag','StaticText_title', ...
    ...
    'String','Pre-Multifractal Measure Synthesis - 1D');

%%%%%%%%%%%%%%%%%%%% GLOBAL PARAMETERS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
uicontrol('Parent',a,'Style','radiobutton','Tag','RadioButton_deterministic', ...
    'Units','normalized','Position',[0.08 0.77 0.4 0.075], ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String','Deterministic', ...
    'Value',1, ...
    'Callback','fl_mmssynthesis_compute(''det_option'')');

uicontrol('Parent',a,'Style','radiobutton','Tag','RadioButton_stochastic', ...
    'Units','normalized','Position',[0.45 0.77 0.35 0.075], ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String','Stochastic', ...
    'Value',0, ...
    'Callback','fl_mmssynthesis_compute(''stoc_option'')');

uicontrol('Parent',a,'Style','popupmenu','Tag','Popupmenu_method', ...
    'Units','normalized','Position',[0.36 0.69 0.56 0.07], ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String',{'Shuffled (micro-canonical)','Perturbated (canonical)', ...
              'Uniform (canonical)','Lognormal (canonical)'}, ...
    'Value',1,'Enable','off', ...
    'Callback','fl_mmssynthesis_compute(''popmenu_method'')');

uicontrol('Parent',a,'Style','text','Tag','StaticText_base', ...
    'Units','normalized','Position',[0.09 0.56 0.14 0.07], ...
    'FontUnits','normalized','FontSize',0.6,'HorizontalAlignment','left', ...
    'String','Base');

uicontrol('Parent',a,'Style','edit','Tag','EditText_base', ...
    'Units','normalized','Position',[0.23 0.575 0.17 0.07], ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String','2', ...
    'Callback','fl_mmssynthesis_compute(''edit_base'')');

uicontrol('Parent',a,'Style','text','Tag','StaticText_scales', ...
    'Units','normalized','Position',[0.55 0.56 0.22 0.07], ...
    'FontUnits','normalized','FontSize',0.6,'HorizontalAlignment','left', ...
    'String','# Scales');

uicontrol('Parent',a,'Style','edit','Tag','EditText_scales', ...
    'Units','normalized','Position',[0.75 0.575 0.17 0.07], ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String','10', ...
    'Callback','fl_mmssynthesis_compute(''edit_scales'')');

uicontrol('Parent',a,'Style','text','Tag','StaticText_sample', ...
    'Units','normalized','Position',[0.35 0.46 0.27 0.07], ...
    'FontUnits','normalized','FontSize',0.6,'HorizontalAlignment','left', ...
    'String','Sample size');

uicontrol('Parent',a,'Style','edit','Tag','EditText_sample', ...
    'Units','normalized','Position',[0.62 0.47 0.3 0.07], ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String','1024','Enable','inactive');

uicontrol('Parent',a,'Style','text','Tag','StaticText_weigths', ...
    'Units','normalized','Position',[0.09 0.36 0.2 0.07], ...
    'FontUnits','normalized','FontSize',0.6,'HorizontalAlignment','left', ...
    'String','Weights');

uicontrol('Parent',a,'Style','edit','Tag','EditText_weigths', ...
    'Units','normalized','Position',[0.3 0.37 0.62 0.07], ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String','[0.4;0.6]', ...
    'Callback','fl_mmssynthesis_compute(''edit_weigths'')');

uicontrol('Parent',a,'Style','text','Tag','StaticText_parameter', ...
    'Units','normalized','Position',[0.37 0.251 0.37 0.07], ...
    'FontUnits','normalized','FontSize',0.6,'HorizontalAlignment','left', ...
    'String','Perturbation','Enable','off');

uicontrol('Parent',a,'Style','edit','Tag','EditText_parameter', ...
    'Units','normalized','Position',[0.75 0.27 0.17 0.07], ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String','1','Enable','off', ...
    'Callback','fl_mmssynthesis_compute(''edit_parameter'')');

uicontrol('Parent',a,'Style','Checkbox','Tag','Check_spectrum', ...
    'Units','normalized','Position',[0.09 0.17 0.7 0.07], ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String','Theoretical multifractal spectrum', ...
    'Value',0, ...
    'Callback','fl_mmssynthesis_compute(''check_spectrum'')');
