function fig = gui_fl_estimOSC1DH()
...
a = figure('Name','Oscillation based estimation 1D','Tag','Fig_gui_fl_estimOSC1DH',...
...
uicontrol('Parent',a,'Style','text','Tag','StaticText_title', ...
    ...
    'String','Estimation of Holder exponent - Oscillation method 1D');
...
uicontrol('Parent',a,'Tag','Button_refresh', ...
    ...
    'String','Refresh', ...
    'Callback','fl_estimOSC1DH_compute(''refresh'')');

%%%%%%%%%%%%% SAMPLING AND ZONES PARAMETERS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
uicontrol('Parent',a,'Style','text','Tag','StaticText_base', ...
    'Units','normalized','Position',[0.088 0.595 0.1 0.07], ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String','Base');
...
uicontrol('Parent',a,'Style','edit','Tag','EditText_base', ...
    ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String','2.1', ...
    'Callback','fl_estimOSC1DH_compute(''edit_base'')');

uicontrol('Parent',a,'Style','Text','Tag','StaticText_alpha', ...
    'Units','normalized','Position',[0.41 0.595 0.1 0.07], ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String','Alpha');
...
uicontrol('Parent',a,'Style','edit','Tag','EditText_alpha', ...
    ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String','0.1', ...
    'Callback','fl_estimOSC1DH_compute(''edit_alpha'')');

uicontrol('Parent',a,'Style','text','Tag','StaticText_beta', ...
    'Units','normalized','Position',[0.705 0.595 0.1 0.07], ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String','Beta');
...
uicontrol('Parent',a,'Style','edit','Tag','EditText_beta', ...
    ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String','0.3', ...
    'Callback','fl_estimOSC1DH_compute(''edit_beta'')');
...
uicontrol('Parent',a,'Style','edit','Tag','EditText_zones', ...
    ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String','10', ...
    'Callback','fl_estimOSC1DH_compute(''edit_zones'')');

%%%%%%%%%%%%%%%%%%% AVERAGING PARAMETERS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
uicontrol('Parent',a,'Style','Checkbox','Tag','Check_average', ...
    'Units','normalized','Position',[0.1 0.41 0.25 0.07], ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String','No Averaging', ...
    'Value',0, ...
    'Callback','fl_estimOSC1DH_compute(''check_average'')');
...
uicontrol('Parent',a,'Style','edit','Tag','EditText_gamma', ...
    ...
    'String','0.4', ...
    'Enable','off', ...
    'Callback','fl_estimOSC1DH_compute(''edit_gamma'')');
...
uicontrol('Parent',a,'Style','edit','Tag','EditText_delta', ...
    ...
    'String','1', ...
    'Enable','off', ...
    'Callback','fl_estimOSC1DH_compute(''edit_delta'')');

%%%%%%%%%%%%%%%% TIME INSTANT PARAMETERS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
uicontrol('Parent',a,'Style','Checkbox','Tag','Check_timeinstant', ...
    'Units','normalized','Position',[0.1 0.3 0.40 0.07], ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String','Holder Function', ...
    'Value',1, ...
    'Callback','fl_estimOSC1DH_compute(''check_time'')');

uicontrol('Parent',a,'Style','text','Tag','StaticText_timeinstant', ...
    'Units','normalized','Position',[0.59 0.295 0.20 0.07], ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String','Time Instant', ...
    'Enable','off');
...
uicontrol('Parent',a,'Style','edit','Tag','EditText_timeinstant', ...
    'Units','normalized','Position',[0.82 0.31 0.12 0.07], ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String',num2str(floor(1+N*rand(1))), ...
    'Enable','off', ...
    'Callback','fl_estimOSC1DH_compute(''edit_time'')');

%%%%%%%%%%%%%%%%%%% REGRESSION PARAMETERS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
uicontrol('Parent',a,'Style','text','Tag','StaticText_regression', ...
    'Units','normalized','Position',[0.15 0.18 0.19 0.07], ...
    'FontUnits','normalized','FontSize',0.6, ...
    'String','Regression');
...
uicontrol('Parent',a,'Style','popupmenu','Tag','Regtype_menu', ...
    ...
    'Value',1, ...
    'Callback','fl_estimOSC1DH_compute(''regtype'')');
