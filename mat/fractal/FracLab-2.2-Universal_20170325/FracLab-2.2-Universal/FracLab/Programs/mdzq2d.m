...
%   1.  Usage
%
%   [zaq,[a,q]]=mdzq2d(mu_n,[q,[J min max],partstr])
%
%   1.1.  Input parameters
%
%   o  mu_n : strictly positive real matrix
%      Contains the pre-multifractal 2d measure.
%
...
%   value   for  J  is   -log(Nx_n)/log(2.)  where Nx_n is width(mu_n).
%
...
%   5.  See also
%
%   mdzq1d,fczq1d,reynitq,linearlt,mdfl1d,mdfl2d,fcfl1d.
