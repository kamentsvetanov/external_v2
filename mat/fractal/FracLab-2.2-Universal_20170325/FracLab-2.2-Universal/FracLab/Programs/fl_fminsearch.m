function [x,fval,exitflag,output] = fl_fminsearch(funfcn,x,options,varargin)
...
%   $Revision: 1.1.6.1 $  $Date: 2011/09/23 19:09:23 $
...
while func_evals < maxfun && itercount < maxiter
    ...
    if haveoutputfcn || haveplotfcn
        ...
        fl_waitbar('view',h_waitbar,itercount,maxiter-1);
end   % while
