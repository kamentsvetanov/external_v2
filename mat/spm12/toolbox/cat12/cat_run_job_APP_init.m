...
% ______________________________________________________________________
%  $Id: cat_run_job_APP_init.m 1791 2021-04-06 09:15:54Z gaser $
...
%    ds('l2','',0.5,Yo/WMth,Yg<0.2,Yo/WMth,Ym,80)
  ...
  if highBG
    ...
    [HBGth,HBGsd] = cat_stat_kmeans(Ymr(Ymsk(:)),3); HBGsd = min(0.05, HBGsd);
    ...
    WMth2 = cat_stat_kmeans(Ysrc(Yw0(:)),1); 
    Ym    = (Ysrc - BGth) ./ (WMth2 - BGth);
    Ybgc  = Ybg;
  else
