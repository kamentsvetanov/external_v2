...
% ______________________________________________________________________
% $Id: cat_conf_stools.m 1888 2021-10-12 13:49:25Z gaser $
...
vol2tempsurf.help = {
  ...
  '  [rh|lh|mesh].OutputName_VolumeName.Template_T1.gii' 
  ''
...
r2s.ROIs.filter  = 'xml';
r2s.ROIs.ufilter = '.*\.xml$';
r2s.ROIs.dir     = cat_get_defaults('extopts.pth_templates'); 
r2s.ROIs.num     = [1 Inf];
