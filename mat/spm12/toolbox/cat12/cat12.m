...
% ______________________________________________________________________
% $Id: cat12.m 1880 2021-09-28 12:04:36Z gaser $
...
spm_jobman('interactive','','spm.tools.cat.long');
...
h03 = uicontrol(...
  ...
  'FontSize',FS,...
  'FontName',get(0,'defaultuicontrolFontName'),...
  'Style','pushbutton','Callback',@(hObject,eventdata)cat12('pushSegment_Callback',hObject,eventdata,guidata(hObject)));
...
h04 = uicontrol(...
  ...
  'FontSize',FS,...
  'FontName',get(0,'defaultuicontrolFontName'),...
  'Style','pushbutton','Callback',@(hObject,eventdata)cat12('pushSegmentLong_Callback',hObject,eventdata,guidata(hObject)));
...
str_vol = {center('Volume Tools'),...
  ...
  'Save (resampled) Volume Data as mat-File',...
...
userdata_vol = {...
  ...
  'spm_jobman(''interactive'','''',''spm.tools.cat.tools.data2mat'');'...
  'cat_stat_diff;'...
...
h07 = uicontrol(...
  ...
  'TooltipString','Additional Surface Tools',...
  'String',{  center('Surface Tools');...
    ...
    'Map Surface Atlas to Individual Surface';...
    'Save Surface Data as mat-File';...
...
h13 = uicontrol(...
  ...
  'String',{  center('Data Quality');...
    ...
    'Save quality parameters for external analysis';...
    'Check SPM Design';...
  ...
  'UserData',{...
    ...
    'spm_jobman(''interactive'','''',''spm.tools.cat.tools.quality_measures'');'...
    'cat_stat_check_SPM;'...
...
h32 = uicontrol(...
  ...
  'String',{  center('Help');...
    ...
    'Interactive Help' },...
  'UserData',{...
    'web(fullfile(spm(''dir''),''toolbox'',''cat12'',''CAT12-Manual.pdf''),''-browser'');'...
...
appdata = [];
appdata.lastValidTag = 'pushQuickStartGuide_Callback';

h34 = uicontrol(...
  'Parent',h0,...
  'Units','pixels',...
  'String','Quick Start Guide',...
  'Style','pushbutton',...
  'Position',[x2(1) yo x2w bh],...
  'Callback',@(hObject,eventdata)cat12('pushQuickStartGuide_Callback',hObject,eventdata,guidata(hObject)),...
  'TooltipString','Call Quick Start Guide',...
  'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
  'Tag','pushQuickStartGuide',...
  'UserData',[],...
  'FontSize',FS,...
  'FontName',get(0,'defaultuicontrolFontName'));
