...
[AllVolume,VoxelSize,theImgFileList, Header] = rest_to4d([DataUpDir,filesep,SubID{1}]);
...
parfor i = 1:nSubjectNum
    [AllVolume,VoxelSize,theImgFileList, Header] = rest_to4d([DataUpDir,filesep,SubID{i}]);
    % Convert into 2D
