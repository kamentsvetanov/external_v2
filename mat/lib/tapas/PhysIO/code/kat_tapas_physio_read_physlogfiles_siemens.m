...
if ~isempty(log_files.cardiac)
    ...
    if hasScanTimingDicomImage
        ...
        disp(['Phys-dicom       : ' secs2hms(ScanStopTimeSeconds-ScanStartTimeSeconds)]);
...
%     lineData = lineData((iTrigger(end)+4):end);
    ...
    nSamples = size(c,1);
%     dt = dt*2; % Added temporarily to fix a bug where fs was halfed by splitting the data into 2 channels (lines 202-204) kt03 20160311
