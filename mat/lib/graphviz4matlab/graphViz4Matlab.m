...
%             axpos(3) = 0.9;
            ...
            set(obj.ax,'Position',axpos,'XTick',[],'YTick',[],'LineWidth',0.2);
        ...
        function calculateMinMaxNodeSize(obj)
            ...
            SCREEN_PROPORTION_MAX = 1/8;%10;
            SCREEN_PROPORTION_MIN = 1/8;%35;
            units = get(0,'Units');
            set(0,'Units','pixels');
