function [] = rest_Y_ExtractROITC(ADataDir, AROIDef)
...
% Written by YAN Chao-Gan 081212. Referenced from REST.
...
if iscell(AROIDef),	%ROI wise, compute corelations between regions
    ...
    save([SubID,'_ROITimeCourses.mat'],'theROITimeCourses');

    ResultCorr =corrcoef(theROITimeCourses);
    save([SubID,'_ResultCorr.mat'],'ResultCorr');
end%ROI wise
