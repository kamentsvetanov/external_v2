...
text('units', 'normalized', 'string', 'FITv2.0c', 'position', titlePos, 'fontsize', subtitleFont, 'HorizontalAlignment', 'center', ...
...
% authors
fusionInfo = {'', '', ['\bfRelease Date: \rm', num2str('10-May-2012')], '', char('\bfAuthors: \rm\bfVince Calhoun, \rm\bfJean Liu, \rm\bfJing Sui &', '                \rm\bfSrinivas Rachakonda'), ...
