function ica_fuse_parallelICA_permutationtest(parallel_ica_fusion_file, num_permutations, numICARuns)
...
disp(['Percentage of correlation values above the maximally linked component is ', num2str(p)]);
fprintf('\n');
