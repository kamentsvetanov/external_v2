...
% ncomp_snp_max: max testing component number, default = 100;
...
function ica_fuse_snp_est_main(data_snp, numruns)
...
for ncomp_snp = ncomp_snp_min:ncomp_snp_max
    [A_info, W, icasig_info] = getIcassoEstimates(data_snp, ncomp_snp, numruns);
...
function [A, W, icasig] = getIcassoEstimates(data, numOfIC, numRuns)
