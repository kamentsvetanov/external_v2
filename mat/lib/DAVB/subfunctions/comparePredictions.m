...
[y,x] = simulateNLSS(n_t,f_fname,g_fname,theta,phi,u,alpha,sigma,opt);
...
%display predictions
[haf,hf] = plotUncertainTimeSeries(xhat,getVar(vx,length(vx)));
...
[haf,hf] = plotUncertainTimeSeries(yhat,vy);
hold on
plot(y','--')
