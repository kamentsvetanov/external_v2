% pac_cmi() -  calculate phase-amplitude coupling (PAC) using the
%     modulation index (MI) method (see Canolty, 2006)
%
% Usage:
%     >> pac = pac_cmi(lo, hi, f_lo, f_hi, fs);
%
% Inputs:
...
%     >> pac_cmi(lo, hi, [4,8], [80,150], 1000) % Calculate PAC
%     ans =
%         0.2166
%
