function output = FatFilter(input,BW,SW,frequency)
%Create a Gaussian Bell function
%Width of window set by K - typically 8-32
%frequency shift input

time=(0:1:(size(input,1)-1))/SW;
freqshift=exp(1i*time*frequency*2*pi)';
input=input.*freqshift;
