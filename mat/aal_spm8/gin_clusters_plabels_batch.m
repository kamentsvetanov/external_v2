function varargout = gin_clusters_plabels_batch(varargin)
% Display and analysis of SPM{.}
% Hacked for batch scripting:
% Added arguments to specify atlas and threshold for % overlap
% FORMAT TabDat = gin_clusters_plabels('List',SPM,hReg,Num,Dis,Str,atlas,overlap)
% Default atlas = '/usr/local/spmaddons/aal_spm8/ROI_MNI_V4.nii'
% Specify overlap in percent, i.e. 1 = 1%
% You MUST specify Num, Dis, Str. Defaults:
% Num = 3
% Dis = 8
% Str = ['volume summary (labels and percentages per cluster)'];
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Old help info:
...
if length(varargin) > 6
    atlasname = varargin{7};
else
    atlasname = '/usr/local/spmaddons/aal_spm8/ROI_MNI_V4.nii';
end

if length(varargin) > 7
    overlapthr = varargin{8};
else
    overlapthr = 0;
end
