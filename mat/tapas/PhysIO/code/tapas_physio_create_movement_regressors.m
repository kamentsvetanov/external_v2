...
%
% $Id: tapas_physio_create_movement_regressors.m 783 2015-07-23 15:52:51Z kasperla $
...
if verbose.level > 2
   ...
   plot(sumRot*180/pi, '-');
   if nOutlierRot % debugged by kat from nOutlierTrans to nOutlierRot 20160323
       stem(iOutlierRot,...
