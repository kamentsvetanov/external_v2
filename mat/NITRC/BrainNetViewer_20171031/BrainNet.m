...
if length(a)>1
    ...
    if (EC.nod.color == 2||EC.nod.color == 3)&& (FLAG.Loadfile<4||EC.edg.color~=2)
        switch(EC.nod.color)
            case 2
                tmp = EC.nod.CM;
            case 3
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
msgbox({'BrainNet Viewer 1.61 Released 20171031';'By Mingrui Xia';'mingruixia@gmail.com'},'About...','help');
