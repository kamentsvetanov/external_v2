function bfm_plot_brainlv_sa(ViewBootstrapRatio, PLSresultFile, ...
	grp_idx, lv_idx, new_fig, behav_idx, sa, cluster_info, update)
...
%    h_img = image(blv_disp);
    ...
    if grp_idx				% called from datamatcorrs plot
       ...
       set(h_img,'ButtonDownFcn','bfm_result_sa_ui(''SelectPixel'')');
    end
