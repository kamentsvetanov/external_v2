function fig = bfm_result_3v_ui(action,varargin)
   ...
   if ~exist('action','var') | ~ischar(action)
      ...
      bfm_result_3v_ui('Rotation', rot_amount);
      ShowResult(0,0);
...
function h0 = init(PLSResultFile);
   ...
   h0 = figure('Units','normal', ...
   	...
   	'MenuBar','none',...
   	'Position',pos, ...
   	'DeleteFcn','bfm_result_3v_ui(''DeleteFigure'')', ...
   	'Tag','PlotBrainLV');
   %
...
%	'foregroundcolor',[1 0 0], ...
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','bfm_result_3v_ui(''EditLV'')', ...
   	'Tag','LVIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','bfm_result_3v_ui(''EditThresh'')', ...
   	'Tag','Threshold');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','bfm_result_3v_ui(''EditMax'')', ...
   	'Tag','MaxValue');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','bfm_result_3v_ui(''EditMin'')', ...
   	'Tag','MinValue');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'Tooltip','Default set to 95 percentile of Bootstrap ratio', ...
   	'Style','edit', ...
   	'Callback','bfm_result_3v_ui(''UpdatePValue'')', ...
   	'Tag','BSThreshold');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'ToolTipString','Click to select the XYZ you entered', ...
   	'Style','push', ...
   	'Callback','bfm_result_3v_ui(''EditXYZ'')');
...
%   	'Style','popupmenu', ...
%   	'Callback','bfm_result_3v_ui(''XYZmmLabel'')', ...
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'ToolTipString','Voxel coordinates w.r.t. the origin', ...
   	'Style','edit', ...
   	'Callback','bfm_result_3v_ui(''EditXYZmm'')', ...
   	'Tag','XYZmm');
   ...
   h1 = uicontrol('Parent',h0, ...			% rescale button
	...
	'Value',1, ...
	'Visible','off', ...
	'Callback','bfm_result_3v_ui(''RescaleBnPress'')', ...
   	'Tag','RESCALECheckbox');
...
%   	'Callback','bfm_result_3v_ui(''CloseFigure'');', ...
   ...
   h2 = uimenu(h_file, ...
   	   ...
   	   'Tag','LoadBGImage', ...
           'Callback','bfm_result_3v_ui(''LoadBackgroundImage'')'); 
   h2 = uimenu(h_file, ...
           'Label','Save brain region to IMG file', ...
   	   'Tag','SaveBGImage', ...
           'Callback','bfm_result_3v_ui(''SaveBackgroundImage'')'); 
   h2 = uimenu(h_file, ...
           'Label','&Load PLS Result', ...
   	   'Tag','LoadPLSResult', ...
		'visible', 'off', ...
           'Callback','bfm_result_3v_ui(''LoadResultFile'')'); 
   h2 = uimenu(h_file, ...
           'Label','&Save Current Display to the IMG files', ...
   	   'Tag','SaveDisplayToIMG', ...
           'Callback','bfm_result_3v_ui(''SaveDisplayToIMG'')'); 
   h2 = uimenu(h_file, ...
           'Label','&Save BLV to the IMG files', ...
   	   'Tag','SaveResultToIMG', ...
           'Callback','bfm_result_3v_ui(''SaveResultToIMG'')'); 
   ...
   h2 = uimenu('Parent',h0, ...
   	   'Label','&Zoom on', ...
	   'Userdata', 1, ...
           'Callback','bfm_result_3v_ui(''Zooming'')', ...
   	   'Tag','ZoomToggleMenu');
   ...
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&none', ...
   	   'Checked','on', ...
           'Callback','bfm_result_3v_ui(''Rotation'',1)', ...
   	   'Tag','Rotate0Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&90 degree', ...
   	   'Checked','off', ...
           'Callback','bfm_result_3v_ui(''Rotation'',2)', ...
   	   'Tag','Rotate90Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&180 degree', ...
   	   'Checked','off', ...
           'Callback','bfm_result_3v_ui(''Rotation'',3)', ...
   	   'Tag','Rotate180Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&270 degree', ...
   	   'Checked','off', ...
           'Callback','bfm_result_3v_ui(''Rotation'',0)', ...
   	   'Tag','Rotate270Menu');
   ...
   h2 = uimenu('Parent',h_view, ...
   	   ...
   	   'Label','&View Brain LV', ...
	   'Userdata', 1, ...
           'Callback','bfm_result_3v_ui(''Toggle_View'')', ...
   	   'Tag','ViewToggleMenu');
   ...
   h2 = uimenu(h_pls, ...
           'Label','&Singular Values Plot', ...
     	   'Tag','OpenEigenPlot', ...
           'Callback','bfm_result_3v_ui(''OpenEigenPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Behavior LV and Behavior Scores Plot', ...
     	   'Tag','OpenBehavPlot', ...
           'Visible', 'off', ...
           'Callback','bfm_result_3v_ui(''OpenScoresPlot'',0)');
   h2 = uimenu(h_pls, ...
           'Label','&Design Scores and LVs Plot', ...
     	   'Tag','OpenDesignPlot', ...
           'Visible', 'off', ...
           'Callback','bfm_result_3v_ui(''OpenDesignPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','Task PLS Brain Scores with CI', ...
	   'Visible','off', ...
     	   'Tag','OpenTBrainScoresPlot', ...
           'Callback','bfm_result_3v_ui(''OpenTBrainScoresPlot'')');
   h2 = uimenu(h_pls, ...
           'Label','B&rain Scores vs. Behavior Data Plot', ...
     	   'Tag','OpenBrainPlot', ...
           'Visible', 'off', ...
           'Callback','bfm_result_3v_ui(''OpenBrainPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Brain Scores Plot', ...
     	   'Tag','OpenBrainScoresPlot', ...
	'visible','off', ...
           'Callback','bfm_result_3v_ui(''OpenBrainScoresPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Voxel Intensity Response', ...
     	   'Tag','OpenRFPlot', ...
           'Callback','bfm_result_3v_ui(''OpenResponseFnPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Datamat Correlations Response', ...
     	   'Tag','OpenRF1Plot', ...
           'Callback','bfm_result_3v_ui(''OpenCorrelationPlot'')');
%           'Callback','bfm_result_3v_ui(''OpenResponseFnPlot'')');
   h2 = uimenu(h_pls, ...
           'Label','&Datamat Correlations Plot', ...
     	   'Tag','OpenDatamatcorrsPlot', ...
           'Callback','bfm_result_3v_ui(''OpenDatamatcorrsPlot'')'); 
   h2 = uimenu(h_pls, ...
   ...
   h2 = uimenu(h_pls, ...
           ...
           'Callback','bfm_result_3v_ui(''OpenContrastWindow'')'); 
   h2 = uimenu(h_pls, ...
           'Label','Create Brain LV &Figure', ...
	   'separator', 'on', ...
   	   'Tag','PlotNewFigure', ...
		'visible', 'off', ...
           'Callback','bfm_result_3v_ui(''PlotOnNewFigure'')'); 
   h2 = uimenu(h_pls, ...
           'Label','Create Figure', ...
	   'separator', 'on', ...
   ...
   h2 = uimenu(h_pls, ...
           ...
           'Callback','bfm_result_3v_ui(''SetClusterReportOptions'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Load Cluster Report', ...
     	   'Tag','LoadClsuterReport', ...
           'Callback','bfm_result_3v_ui(''LoadClusterReport'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Create Cluster Report', ...
     	   'Tag','OpenClusterReport', ...
           'Callback','bfm_result_3v_ui(''OpenClusterReport'')'); 
   h2 = uimenu(h_pls, ...
           'Label','Cluster Mask', ...
	   'separator', 'on', ...
           'check', 'off', ...
	   'Userdata', 1, ...
   	   'Tag','ClusterMask', ...
           'Callback','bfm_result_3v_ui(''ClusterMask'')'); 
 ...
 %    pet_plot_cluster_mask(cluster_info);
  ...
  if (getappdata(gcf,'ViewBootstrapRatio') == 0),	% plot brain lv 
	...
	return;
     ...
     switch action 
       case {0}
          bfm_plot_brainlv_3v(0,PLSresultFile,0,lv_idx,0,[],cluster_info,update);
       case {1}
          bfm_plot_brainlv_3v(0,PLSresultFile,0,lv_idx,1,[],cluster_info,update);
     end
	...
	return;
     ...
     switch action 
       case {0}
          bfm_plot_brainlv_3v(1,PLSresultFile,0,lv_idx,0,[],cluster_info,update);
       case {1}
          bfm_plot_brainlv_3v(1,PLSresultFile,0,lv_idx,1,[],cluster_info,update);
     end;
...
function OpenDatamatcorrsPlot
   ...
   datamatcorrs_fig = bfm_plot_datamatcorrs_3v;
