...
function fig = erp_analysis_ui(varargin)
   ...
   switch (action)
     ...
     case {'MENU_CREATE_CONTRASTS'}
        ...
        if ~isempty(tmp.CurrGroupProfiles)
           ...
           load(tmp.CurrGroupProfiles{1},'selected_conditions');
        end
        ...
        if get(findobj(gcf,'Tag','SelectNonRotateMultiblock'),'value')
           designdata = rri_input_contrast_ui({'ERP'},pls_session,new_cond_selection,num_groups,'nonrotatemultiblock',0,behavname,ContrastMatrix);
        else
           designdata = rri_input_contrast_ui({'ERP'},pls_session,new_cond_selection,num_groups,[],0,behavname,ContrastMatrix);
        end
	...
	SelectPosthocDataFile;
     case {'BROWSE_CONTRAST_FILE'}
        ...
        [contrast_file,contrast_path] = rri_selectfile('*_ERPcontrast.txt',dlg_title);
        if (contrast_file ~= 0)
	...
	close(gcf);
     ...
     case {'DELETE_FIGURE'}
        ...
        try
           ...
           erp_analysis_pos = get(gcbf,'position');

           save(pls_profile, '-append', 'erp_analysis_pos');
        catch
        end
     otherwise
...
function init()
   ...
   if ~isempty(erp_analysis_pos) & strcmp(save_setting_status,'on')

      pos = erp_analysis_pos;
   ...
   h0 = figure('Color',[0.8 0.8 0.8], ...
	'Units','normal', ...
	'Name','PLS Analysis for ERP datamat', ...
	'NumberTitle', 'off', ...
   	'Position',pos, ...
   	'Menubar','none', ...
        'DeleteFcn','erp_analysis_ui(''DELETE_FIGURE'');', ...
   ...
   h1 = uicontrol('Parent',h0, ...		% scroll bar
	'Style', 'slider', ...
   	...
   	'Value',20, ...
   	'Position',pos, ...
   	'Callback','erp_analysis_ui(''MOVE_SLIDER'');', ...
   	'Tag','GroupSlider');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'Value', 0, ...
        ...
        'HorizontalAlignment','left', ...
        'String','Full Path', ...
        'Callback','erp_analysis_ui(''TOGGLE_FULL_PATH'');', ...
        'Tag','FullPathChkbox');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'Value',1, ...
	'tag','SelectMean', ...
   	'Callback','erp_analysis_ui(''MEAN_SELECTED'');', ...
	'position',pos);
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'tag','SelectContrastData', ...
   	'Callback','erp_analysis_ui(''CONTRASTDATA_SELECTED'');', ...
	'position',pos);
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'Value',0, ...
	'tag','SelectBehavData', ...
   	'Callback','erp_analysis_ui(''BEHAVDATA_SELECTED'');', ...
	'enable','on', ...
	'position',pos);
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'tag','SelectMultiblockData', ...
   	'Callback','erp_analysis_ui(''MULTIBLOCK_SELECTED'');', ...
	'enable','on', ...
	'position',pos);
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'tag','SelectNonRotateBehav', ...
   	'Callback','erp_analysis_ui(''NON_ROTATE_BEHAVPLS_SELECTED'');', ...
	'position',pos);
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'tag','SelectNonRotateMultiblock', ...
   	'Callback','erp_analysis_ui(''NON_ROTATE_MULTIBLOCK_SELECTED'');', ...
	'position',pos);
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'Enable','off', ...
   	...
   	'Callback','erp_analysis_ui(''MENU_MODIFY_BEHAVDATA'');', ...
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'enable','off', ...
   	'Callback','erp_analysis_ui(''MENU_CREATE_CONTRASTS'');', ...
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'Enable','off', ...
   	'Style','edit', ...
   	'Callback','erp_analysis_ui(''EDIT_POSTHOC_DATA_FILE'');', ...
	'visible','off', ...
   	'Tag','PosthocDataEdit');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'Enable','off', ...
   	...
   	'Callback','erp_analysis_ui(''SELECT_POSTHOC_DATA_FILE'');', ...
   	'Tag','PosthocDataBn');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'String','0', ...
   	'Style','edit', ...
   	'Callback','erp_analysis_ui(''EDIT_NUM_PERM'');', ...
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Style','edit', ...
	'Enable', 'on', ...
   	'Callback','erp_analysis_ui(''EDIT_NUM_SPLIT'');', ...
   	'Tag','NumSplitEdit');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'Tooltip','Requires at least 3 subjects per group', ...
   	'Callback','erp_analysis_ui(''EDIT_NUM_BOOT'');', ...
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'visible', 'off', ...
   	...
   	'Callback','erp_analysis_ui(''NONROTATED_BOOT'');', ...
        'Tag','nonrotated_boot');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'String','Run', ...
   	'Callback','erp_analysis_ui(''RUN_BUTTON_PRESSED'');', ...
   	'Tag','RUNButton');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'String','Cancel', ...
   	'Callback','erp_analysis_ui(''CANCEL_BUTTON_PRESSED'');', ...
   	'Tag','CANCELButton');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Callback','erp_analysis_ui(''CRUN_BUTTON_PRESSED'');', ...
   	'Tag','CRUNButton');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Callback','erp_analysis_ui(''LOADBATCH_BUTTON_PRESSED'');', ...
   	'Tag','LOADBATCHButton');
   ...
   m1 = uimenu(h_deselect, ...
   	...
   	'Callback','erp_analysis_ui(''MENU_DESELECT_CONDITION'');', ...
 ...
 %       'Label', 'Modify Behavior Data (behavior data should only contain the above selected conditions)', ...
  % 	'Callback','erp_analysis_ui(''MENU_MODIFY_BEHAVDATA'');', ...
   ...
   m1 = uimenu(h_deselect, ...
   	...
   	'Callback','erp_analysis_ui(''MENU_MULTIBLOCK_DESELECT_CONDITION'');', ...
	'enable', 'off', ...
...
%           'Callback','rri_helpfile_ui(''erp_analysis_hlp.txt'',''How to use PLS ANALYSIS'');', ...
   ...
   session_lst = dir('*_ERPsession.mat');
   sessiondata_lst = dir('*_ERPsessiondata.mat');
...
function SetupGroupRows()
   ...
   edit_cbf = '';
   select_cbf = 'erp_analysis_ui(''SELECT_GROUP'');';
   delete_cbf = 'erp_analysis_ui(''DELETE_GROUP'');';
...
function CreateAddRow()
   ...
   set(a_hdls(3),'String','Add','Visible','off', ...
		     'Callback','erp_analysis_ui(''ADD_GROUP'');');
...
function AddGroupProfiles()
   ...
   if isempty(group_profile)
      ...
      pf_path = fullfile(pf_path, '*_ERPsessiondata.mat');
...
function status = SavePLSOptions
   ...
   for i=1:num_groups
      ...
      if (isbehav | ismultiblock | isnonrotatebehav) & isempty(PLSoptions.behavdata_lst) & isempty(behavdata)
         msg = ['ERROR: Behavior data is required'];
         set(findobj(gcf,'Tag','MessageLine'),'String',msg);
         return;
      elseif (isbehav | ismultiblock | isnonrotatebehav) & ~isempty(PLSoptions.behavdata_lst)  % behavdata input from run
         num_behavdata_col = size(PLSoptions.behavdata_lst{1},2);
         setappdata(gcf,'num_selected_behav',num_behavdata_col);
      elseif isbehav | ismultiblock | isnonrotatebehav			% behavdata from session
...
if isempty(ContrastMatrix)
         try
            ...
            if (iscontrast == 1 & size(use_contrast,1) ~= sum(new_cond_selection)*num_groups ) | ...
              (isnonrotatebehav == 1 & size(use_contrast,1) ~= sum(new_cond_selection)*num_groups*length(behavname)) | ...
              (isnonrotatemultiblock == 1 & size(use_contrast,1) ~= sum(new_cond_selection)*num_groups*(1+length(behavname)))
...
function ExecutePLS()
   ...
   if exist('plslog.m','file')
      ...
      elseif PLSoptions.isnonrotatebehav
         plslog('ERP Non-Rotated Behavior Analysis');
      elseif PLSoptions.isnonrotatemultiblock
         plslog('ERP Non-Rotated Multiblock Analysis');
      elseif PLSoptions.isbehav
         plslog('ERP Regular Behavior Analysis');
      elseif PLSoptions.iscontrast
         plslog('ERP Non-Rotated Task Analysis');
      else
         plslog('ERP Mean-Centering Analysis');
      end
   end

   [resultFile] = erp_analysis(PLSoptions.ismean, ...
...
function modify_behavdata
   ...
   if isempty(behavdata) | isempty(new_evt_list)
      [status,behavname,behavdata,behavdata_lst,new_evt_list,newdata_lst] = ...
		erp_get_behavior(curr_profiles, cond_selection);
...
function status = cExecutePLS()
   ...
   if exist('plslog.m','file')
      if PLSoptions.ismultiblock
         plslog('cERP Multiblock Analysis');
      elseif PLSoptions.isnonrotatebehav
         plslog('cERP Non-Rotated Behavior Analysis');
      elseif PLSoptions.isnonrotatemultiblock
         plslog('cERP Non-Rotated Multiblock Analysis');
      elseif PLSoptions.isbehav
         plslog('cERP Regular Behavior Analysis');
      elseif PLSoptions.iscontrast
         plslog('cERP Non-Rotated Task Analysis');
      else
         plslog('cERP Mean-Centering Analysis');
      end
   end
   ...
   [result_file,result_path] = ...
      rri_selectfile([datamat_prefix,'_ERPresult.mat'],'Please enter a result file name that will be used by the created batch file');
   ...
   [input_file,input_path] = ...
      rri_selectfile([datamat_prefix,'_ERPanalysis.txt'],'Please enter a batch file name that will be used by "batch_plsgui"');
...
%   end
   ...
   if ~isempty(findstr(first_file, '_ERPsessiondata.mat'))	% ERP
