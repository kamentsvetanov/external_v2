function fig = pet_result_3v_ui(action,varargin)
...
%      pet_result_3v_ui('Rotation', rot_amount);
      ShowResult(0,0);
...
function h0 = init(PLSResultFile);
   ...
   h0 = figure('Units','normal', ...
   	...
   	'MenuBar','none',...
   	'Position',pos, ...
   	'DeleteFcn','pet_result_3v_ui(''DeleteFigure'')', ...
   	'Tag','PlotBrainLV');
   %
   ...
   h1 = uicontrol('Parent',h0, ...			% lv index edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','pet_result_3v_ui(''EditLV'')', ...
   	'Tag','LVIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...			% threshold edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','pet_result_3v_ui(''EditThresh'')', ...
   	'Tag','Threshold');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'Tooltip','Default set to 95 percentile of Bootstrap ratio', ...
   	'Style','edit', ...
   	'Callback','pet_result_3v_ui(''UpdatePValue'')', ...
   	'Tag','BSThreshold');
...
%   	'Callback','pet_result_3v_ui(''CloseFigure'');', ...
   ...
   h2 = uimenu(h_pls, ...
	   ...
	   'Visible','off', ...
           ...
           'Callback','pet_result_3v_ui(''OpenBrainScoresPlot'')');
   h2 = uimenu(h_pls, ...
 ...
 %    pet_plot_cluster_mask(cluster_info);
  ...
  if (getappdata(gcf,'ViewBootstrapRatio') == 0),	% plot brain lv
	...
	return;
     ...
     switch action
       case {0}
          pet_plot_brainlv_3v(0,PLSresultFile,0,lv_idx,0,[],cluster_info,update);
       case {1}
          pet_plot_brainlv_3v(0,PLSresultFile,0,lv_idx,1,[],cluster_info,update);
     end
	...
	return;
     ...
     switch action
       case {0}
          pet_plot_brainlv_3v(1,PLSresultFile,0,lv_idx,0,[],cluster_info,update);
       case {1}
          pet_plot_brainlv_3v(1,PLSresultFile,0,lv_idx,1,[],cluster_info,update);
     end;
