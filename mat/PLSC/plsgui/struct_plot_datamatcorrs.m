...
function fig = struct_plot_datamatcorrs(action,varargin)
...
%      set(gcbf,'visible','on');
      ...
      struct_plot_datamatcorrs('Rotation', rot_amount);
   ...
   elseif (strcmp(action,'DeleteNewFigure'))
      try
         ...
         struct_plot_datamatcorrs_newfig_pos = get(gcbf,'position');

         save(pls_profile, '-append', 'struct_plot_datamatcorrs_newfig_pos');
      catch
      end
   elseif (strcmp(action,'DeleteFigure'))
     try
        ...
        struct_plot_datamatcorrs_pos = get(gcbf,'position');

        save(pls_profile, '-append', 'struct_plot_datamatcorrs_pos');
     catch
     end
...
function h0 = init(PLSResultFile);
   ...
   if ~isempty(struct_plot_datamatcorrs_pos) & strcmp(save_setting_status,'on')

      pos = struct_plot_datamatcorrs_pos;
...
%   [r_path,r_file,r_ext] = fileparts(PLSResultFile);
   ...
   h0 = figure('Units','normal', ...
   	...
   	'MenuBar','none',...
   	'Position',pos, ...
   	'DeleteFcn','struct_plot_datamatcorrs(''DeleteFigure'')', ...
   	'Tag','PlotBrainLV');
   %
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','struct_plot_datamatcorrs(''EditGroup'')', ...
   	'Tag','GroupIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...			% lv index edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','struct_plot_datamatcorrs(''EditLV'')', ...
   	'Tag','LVIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...			% behav index edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','struct_plot_datamatcorrs(''EditBehav'')', ...
   	'Tag','BehavIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...			% threshold edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
        'Callback','struct_plot_datamatcorrs(''PlotBnPress'')', ...
   	'Tag','Threshold');
   ...
   h1 = uicontrol('Parent',h0, ...			% lv index edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','struct_plot_datamatcorrs(''EditBSLV'')', ...
   	'Tag','BSLVIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','struct_plot_datamatcorrs(''UpdatePValue'')', ...
   	'Tag','BSThreshold');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'ToolTipString','Click to select the XYZ you entered', ...
   	'Style','push', ...
   	'Callback','struct_plot_datamatcorrs(''EditXYZ'')');
   ...
   h1 = uicontrol('Parent',h0, ...			% Origin text
	...
	'ToolTipString','Voxel coordinates w.r.t. the origin', ...
   	'Style','edit', ...
   	'Callback','struct_plot_datamatcorrs(''EditXYZmm'')', ...
   	'Tag','XYZmm');
   ...
   h2 = uimenu(h_file, ...
           ...
           'Tag','LoadBGImage', ...
           'Callback','struct_plot_datamatcorrs(''LoadBackgroundImage'')');
   h2 = uimenu(h_file, ...
           'Label','Save brain region to IMG file', ...
   	   'Tag','SaveBGImage', ...
           'Callback','struct_plot_datamatcorrs(''SaveBackgroundImage'')');
   h2 = uimenu(h_file, ...
           'Label','&Load PLS Result', ...
   	   'Tag','LoadPETResult', ...
		'visible', 'off', ...
           'Callback','struct_plot_datamatcorrs(''LoadResultFile'')');
   h2 = uimenu(h_file, ...
           'Label','&Save Current Display to the IMG files', ...
   	   'Tag','SaveDisplayToIMG', ...
           'Callback','struct_plot_datamatcorrs(''SaveDisplayToIMG'')'); 
   h2 = uimenu(h_file, ...
           'Label','&Save DatamatCorrelation to IMG file', ...
   	   'Tag','SaveResultToIMG', ...
           'Callback','struct_plot_datamatcorrs(''SaveResultToIMG'')');
   h2 = uimenu(h_file, ...
           'Label','Create Datamat Correlations &Figure', ...
   	   'Tag','PlotNewFigure', ...
           'Callback','struct_plot_datamatcorrs(''PlotOnNewFigure'')');
   ...
   h2 = uimenu('Parent',h0, ...
   	   'Label','&Zoom on', ...
	   'Userdata', 1, ...
           'Callback','struct_plot_datamatcorrs(''Zooming'')', ...
   	   'Tag','ZoomToggleMenu');
   ...
   h2 = uimenu('Parent',h_rot, ...
   	   ...
   	   'Checked','on', ...
           'Callback','struct_plot_datamatcorrs(''Rotation'',1)', ...
   	   'Tag','Rotate0Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&90 degree', ...		% another 90 degree
   	   'Checked','off', ...
           'Callback','struct_plot_datamatcorrs(''Rotation'',2)', ...
   	   'Tag','Rotate90Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&180 degree', ...		% now become 270 degree
   	   'Checked','off', ...
           'Callback','struct_plot_datamatcorrs(''Rotation'',3)', ...
   	   'Tag','Rotate180Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&270 degree', ...		% now completed 360 degree
   	   'Checked','off', ...
           'Callback','struct_plot_datamatcorrs(''Rotation'',0)', ...
   	   'Tag','Rotate270Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','Convert Orientation', ...
	   'separator', 'on', ...
           'Callback','struct_plot_datamatcorrs(''orient'',0)', ...
		'visible', 'off', ...
   	   'Tag','orient');
   ...
   h2 = uimenu(h_pls, ...
           'Label','&Singular Values Plot', ...
     	   'Tag','OpenEigenPlot', ...
           'Callback','struct_plot_datamatcorrs(''OpenEigenPlot'')');
   h2 = uimenu(h_pls, ...
           'Label','&Behavior LV and Behavior Scores Plot', ...
	   'Visible','off', ...
     	   'Tag','OpenBehavPlot', ...
           'Callback','struct_plot_datamatcorrs(''OpenScoresPlot'',0)');
   h2 = uimenu(h_pls, ...
           'Label','&Design LV and Design Scores Plot', ...
	   'Visible','off', ...
     	   'Tag','OpenDesignPlot', ...
           'Callback','struct_plot_datamatcorrs(''OpenScoresPlot'',1)');
   h2 = uimenu(h_pls, ...
           'Label','B&rain Scores vs. Behavior Data Plot', ...
     	   'Tag','OpenBrainPlot', ...
           'Callback','struct_plot_datamatcorrs(''OpenBrainPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Voxel Intensity Response', ...
     	   'Tag','OpenRFPlot', ...
           'Callback','struct_plot_datamatcorrs(''OpenResponseFnPlot'')'); 
   h2 = uimenu(h_pls, ...
   ...
   h2 = uimenu(h_pls, ...
           ...
           'Callback','struct_plot_datamatcorrs(''OpenDatamatcorrsPlot'')'); 
   h2 = uimenu(h_pls, ...
   ...
   h2 = uimenu(h_pls, ...
           ...
           'Callback','struct_plot_datamatcorrs(''SetClusterReportOptions'')');
   h2 = uimenu(h_pls, ...
           'Label','&Load Cluster Report', ...
     	   'Tag','LoadClsuterReport', ...
           'Callback','struct_plot_datamatcorrs(''LoadClusterReport'')');
   h2 = uimenu(h_pls, ...
           'Label','&Create Cluster Report', ...
     	   'Tag','OpenClusterReport', ...
           'Callback','struct_plot_datamatcorrs(''OpenClusterReport'')');
...
%
  ...
  if (getappdata(gcf,'ViewBootstrapRatio') == 0),	% plot brain lv
     ...
     switch action
       case {0}
          pet_plot_brainlv(0,PLSresultFile,grp_idx,lv_idx,0,behav_idx,[],update,1);
       case {1}
          pet_plot_brainlv(0,PLSresultFile,grp_idx,lv_idx,1,behav_idx,[],update,1);
     end
     ...
     switch action
       case {0}
          pet_plot_brainlv(2,PLSresultFile,grp_idx,lv_idx,0,behav_idx,[],update,1);
       case {1}
          pet_plot_brainlv(2,PLSresultFile,grp_idx,lv_idx,1,behav_idx,[],update,1);
     end;
...
function orient
   ...
   struct_plot_datamatcorrs('Rotation',1);
