function fig = fmri_plot_datamatcorrs(action,varargin)
%
%  USAGE: fig = fmri_plot_datamatcorrs(action,varargin)
%
...
%      set(gcbf,'visible','off');
      ...
      fmri_plot_datamatcorrs('Rotation', rot_amount);
   ...
   elseif (strcmp(action,'DeleteNewFigure'))
      try
         ...
         fmri_plot_datamatcorrs_newfig_pos = get(gcbf,'position');

         save(pls_profile, '-append', 'fmri_plot_datamatcorrs_newfig_pos');
      catch
      end
   elseif (strcmp(action,'DeleteFigure'))
      try
         ...
         fmri_plot_datamatcorrs_pos = get(gcbf,'position');

         save(pls_profile, '-append', 'fmri_plot_datamatcorrs_pos');
      catch
      end
...
function h0 = init(PLSResultFile);
   ...
   if ~isempty(fmri_plot_datamatcorrs_pos) & strcmp(save_setting_status,'on')

      pos = fmri_plot_datamatcorrs_pos;
...
%   [r_path,r_file,r_ext] = fileparts(PLSResultFile);
   ...
   h0 = figure('Units','normal', ...
   	...
   	'MenuBar','none',...
   	'Position',pos, ...
   	'DeleteFcn','fmri_plot_datamatcorrs(''DeleteFigure'')', ...
   	'Tag','PlotBrainLV');
   %
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','fmri_plot_datamatcorrs(''EditGroup'')', ...
   	'Tag','GroupIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','fmri_plot_datamatcorrs(''EditLV'')', ...
   	'Tag','LVIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','fmri_plot_datamatcorrs(''EditBehav'')', ...
   	'Tag','BehavIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','fmri_plot_datamatcorrs(''EditFirstSlice'')', ...
   	'Tag','FirstSlice');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','fmri_plot_datamatcorrs(''EditStep'')', ...
   	'Tag','SliceStep');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','fmri_plot_datamatcorrs(''EditLastSlice'')', ...
   	'Tag','LastSlice');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','fmri_plot_datamatcorrs(''EditMin'')', ...
   	'Tag','MinValue');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','fmri_plot_datamatcorrs(''EditMax'')', ...
   	'Tag','MaxValue');
   ...
   h1 = uicontrol('Parent',h0, ...			% lv index edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','fmri_plot_datamatcorrs(''EditBSLV'')', ...
   	'Tag','BSLVIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','fmri_plot_datamatcorrs(''UpdatePValue'')', ...
   	'Tag','BSThreshold');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'ToolTipString','Click to select the XYZ you entered', ...
   	'Style','push', ...
   	'Callback','fmri_plot_datamatcorrs(''EditXYZ'')');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'ToolTipString','Voxel coordinates w.r.t. the origin', ...
   	'Style','edit', ...
   	'Callback','fmri_plot_datamatcorrs(''EditXYZmm'')', ...
   	'Tag','XYZmm');
   ...
   h1 = uicontrol('Parent',h0, ...
   	'Units','normal', ...
   	'Callback','fmri_plot_datamatcorrs(''PlotBnPress'')', ...
	'fontunit','normal', ...
   	'FontSize',fnt, ...
   	'ListboxTop',0, ...
   	'Position',pos, ...
   ...
   h2 = uimenu(h_file, ...
   	   ...
   	   'Tag','LoadBGImage', ...
           'Callback','fmri_plot_datamatcorrs(''LoadBackgroundImage'')'); 
   h2 = uimenu(h_file, ...
           'Label','Save brain region to IMG file', ...
   	   'Tag','SaveBGImage', ...
           'Callback','fmri_plot_datamatcorrs(''SaveBackgroundImage'')'); 
   h2 = uimenu(h_file, ...
           'Label','&Load PLS Result', ...
   	   'Tag','LoadPLSResult', ...
		'visible', 'off', ...
           'Callback','fmri_plot_datamatcorrs(''LoadResultFile'')'); 
   h2 = uimenu(h_file, ...
           'Label','&Save Current Display to the IMG files', ...
   	   'Tag','SaveDisplayToIMG', ...
           'Callback','fmri_plot_datamatcorrs(''SaveDisplayToIMG'')'); 
   h2 = uimenu(h_file, ...
           'Label','&Save DatamatCorrelation to IMG file', ...
   	   'Tag','SaveResultToIMG', ...
           'Callback','fmri_plot_datamatcorrs(''SaveResultToIMG'')'); 
   h2 = uimenu(h_file, ...
           'Label','Create Datamat Correlations &Figure', ...
   	   'Tag','PlotNewFigure', ...
           'Callback','fmri_plot_datamatcorrs(''PlotOnNewFigure'')'); 
   ...
   h2 = uimenu('Parent',h0, ...
   	   'Label','&Zoom on', ...
	   'Userdata', 1, ...
           'Callback','fmri_plot_datamatcorrs(''Zooming'')', ...
   	   'Tag','ZoomToggleMenu');
   ...
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&none', ...
   	   'Checked','on', ...
           'Callback','fmri_plot_datamatcorrs(''Rotation'',1)', ...
   	   'Tag','Rotate0Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&90 degree', ...
   	   'Checked','off', ...
           'Callback','fmri_plot_datamatcorrs(''Rotation'',2)', ...
   	   'Tag','Rotate90Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&180 degree', ...
   	   'Checked','off', ...
           'Callback','fmri_plot_datamatcorrs(''Rotation'',3)', ...
   	   'Tag','Rotate180Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&270 degree', ...
   	   'Checked','off', ...
           'Callback','fmri_plot_datamatcorrs(''Rotation'',0)', ...
   	   'Tag','Rotate270Menu');
   ...
   h2 = uimenu(h_pls, ...
           'Label','&Singular Values Plot', ...
     	   'Tag','OpenEigenPlot', ...
           'Callback','fmri_plot_datamatcorrs(''OpenEigenPlot'')'); 
   h2 = uimenu(h_pls, ...
   ...
   h2 = uimenu(h_pls, ...
           'Label','&Design Scores and LVs Plot', ...
     	   'Tag','OpenDesignPlot', ...
           'Visible', 'off', ...
           'Callback','fmri_plot_datamatcorrs(''OpenDesignPlot'')'); 
   h2 = uimenu(h_pls, ...
   ...
   h2 = uimenu(h_pls, ...
           ...
           'Callback','fmri_plot_datamatcorrs(''OpenBrainScoresPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Response Function Plot', ...
     	   'Tag','OpenRFPlot', ...
           'Callback','fmri_plot_datamatcorrs(''OpenResponseFnPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Datamat Correlations Response', ...
     	   'Tag','OpenRF1Plot', ...
           'Callback','fmri_plot_datamatcorrs(''OpenCorrelationPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Datamat Correlations Plot', ...
     	   'Tag','OpenDatamatcorrsPlot', ...
           'Callback','fmri_plot_datamatcorrs(''OpenDatamatcorrsPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Contrasts Information', ...
     	   'Tag','OpenContrastWindow', ...
           'Callback','fmri_plot_datamatcorrs(''OpenContrastWindow'')'); 
   h2 = uimenu(h_pls, ...
   ...
   h2 = uimenu(h_pls, ...
           ...
           'Callback','fmri_plot_datamatcorrs(''SetClusterReportOptions'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Load Cluster Report', ...
     	   'Tag','LoadClsuterReport', ...
           'Callback','fmri_plot_datamatcorrs(''LoadClusterReport'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Create Cluster Report', ...
     	   'Tag','OpenClusterReport', ...
           'Callback','fmri_plot_datamatcorrs(''OpenClusterReport'')'); 
...
%
  ...
  if (getappdata(gcf,'ViewBootstrapRatio') == 0),	% plot brain lv 
     ...
     switch action 
       case {0}
          plot_st_brainlv(PLSresultFile,grp_idx,behav_idx,lv_idx,slice_idx,thresh,range,0,[],update);
       case {1}
          plot_st_brainlv(PLSresultFile,grp_idx,behav_idx,lv_idx,slice_idx,thresh,range,1,[],update);
     end;
     ...
     switch action 
       case {0}
          plot_bs_ratio(PLSresultFile,grp_idx,behav_idx,lv_idx,slice_idx,thresh,range,0,[],update);
       case {1}
          plot_bs_ratio(PLSresultFile,grp_idx,behav_idx,lv_idx,slice_idx,thresh,range,1,[],update);
     end;
...
%-------------------------------------------------------------------------
%   
function plot_st_brainlv(PLSresultFile,grp_idx,behav_idx,lv_idx,slice_idx,thresh,range,new_fig,cluster_info,update)
% 
...
if 0
  ...
  set(h_img,'ButtonDownFcn','fmri_plot_datamatcorrs(''SelectPixel'')');
  create_colorbar( colorbar_hdl, cbar, min_blv, max_blv );
...
%-------------------------------------------------------------------------
%   
function plot_bs_ratio(PLSresultFile,grp_idx,behav_idx,lv_idx,slice_idx,thresh,range,new_fig,cluster_info,update)
% 
%  USAGE:  plot_st_brainlv(PLSresultFile,lv_idx,slice_idx,thresh,range,new_fig)
%
%
...
function EditGroup()
   ...
   if isempty(grp_idx),
      ...
      set(findobj(gcf,'Tag','MessageLine'),'String',msg);
      set(grp_idx_hdl,'String',num2str(getappdata(gcf,'CurrGroupIdx')));
      return;
   end;
...
function EditBehav()
   ...
   if isempty(behav_idx),
      ...
      set(findobj(gcf,'Tag','MessageLine'),'String',msg);
      set(behav_idx_hdl,'String',num2str(getappdata(gcf,'CurrBehavIdx')));
      return;
   end;
...
function EditBSLV()
   ...
   if isempty(lv_idx),
      ...
      set(findobj(gcf,'Tag','MessageLine'),'String',msg);
      set(lv_idx_hdl,'String',num2str(getappdata(gcf,'CurrBSLVIdx')));
      return;
   end;
...
function SelectPixel()
   ...
   coord = (slice_idx(col)-1)*st_dims(1)*st_dims(2) + ...
	     (cur_y-1)*st_dims(1)+cur_x;
...
function EditXYZ()
   ...
   img_rotated = getappdata(gcf,'ImgRotateFlg');
   rot_amount = getappdata(gcf,'RotateAmount');
   st_origin = getappdata(gcf,'STOrigin');
   st_voxel_size = getappdata(gcf,'STVoxelSize');
   ...
   if (col<1 | col>length(getappdata(gcf,'SliceIdx')) | row<1 | row>getappdata(gcf,'WinSize'))
      msg = 'Invalid number in X, Y, or Z';
      set(findobj(gcf,'Tag','MessageLine'),'String',msg);
      return;
   end
...
function [axes_h,colorbar_h] = create_new_blv_figure();
   ...
   save_setting_status = 'on';
   fmri_plot_datamatcorrs_newfig_pos = [];
   ...
   if ~isempty(fmri_plot_datamatcorrs_newfig_pos) & strcmp(save_setting_status,'on')

      pos = fmri_plot_datamatcorrs_newfig_pos;
   ...
   fig_h = figure('Units','normal', ...
   	...
   	'DoubleBuffer','on', ...
   	'Position',pos, ...
   	'DeleteFcn','fmri_plot_datamatcorrs(''DeleteNewFigure'')', ...
