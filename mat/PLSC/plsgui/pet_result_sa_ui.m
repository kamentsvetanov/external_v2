...
function h0 = init(PLSResultFile, sa)
   ...
   h1 = uicontrol('Parent',h0, ...			% lv index edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','pet_result_sa_ui(''EditLV'')', ...
   	'Tag','LVIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...			% threshold edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','pet_result_sa_ui(''EditThresh'')', ...
   	'Tag','Threshold');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   h1 = uicontrol('Parent',h0, ...			% max value edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','pet_result_sa_ui(''EditMax'')', ...
   	'Tag','MaxValue');
   x = .05;
   y = y-h-.02;
   w = .12;
   ...
   h1 = uicontrol('Parent',h0, ...			% min value edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','pet_result_sa_ui(''EditMin'')', ...
   	'Tag','MinValue');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'Tooltip','Default set to 95 percentile of Bootstrap ratio', ...
   	'Style','edit', ...
   	'Callback','pet_result_sa_ui(''UpdatePValue'')', ...
   	'Tag','BSThreshold');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'ToolTipString','Click to select the XYZ you entered', ...
   	'Style','push', ...
   	'Callback','pet_result_sa_ui(''EditXYZ'')');
...
%   	'Style','popupmenu', ...
%   	'Callback','pet_result_sa_ui(''XYZmmLabel'')', ...
   ...
   h1 = uicontrol('Parent',h0, ...			% Origin text
	...
	'ToolTipString','Voxel coordinates w.r.t. the origin', ...
   	'Style','edit', ...
   	'Callback','pet_result_sa_ui(''EditXYZmm'')', ...
   	'Tag','XYZmm');
   ...
   h1 = uicontrol('Parent',h0, ...			% rescale button
	...
	'Value',1, ...
	'Visible','off', ...
	'Callback','pet_result_sa_ui(''RescaleBnPress'')', ...
   	'Tag','RESCALECheckbox');
...
%   	'Units','pixels', ...
%   	'Callback','pet_result_sa_ui(''PlotBnPress'')', ...
%   	'FontSize',10, ...
%   	'ListboxTop',0, ...
...
%        'Callback','pet_result_sa_ui(''CloseFigure'');', ...
   ...
   h2 = uimenu(h_file, ...
		...
		'visible','off', ...
           'Callback','pet_result_sa_ui(''LoadTemplateFile'')');

   h2 = uimenu(h_file, ...
           'Label','&Load Background Image', ...
           'Tag','LoadBGImage', ...
           'Callback','pet_result_sa_ui(''LoadBackgroundImage'')');
   h2 = uimenu(h_file, ...
           'Label','Save brain region to IMG file', ...
   	   'Tag','SaveBGImage', ...
           'Callback','pet_result_sa_ui(''SaveBackgroundImage'')'); 
   h2 = uimenu(h_file, ...
           'Label','&Load PLS Result', ...
   	   'Tag','LoadPETResult', ...
		'visible', 'off', ...
           'Callback','pet_result_sa_ui(''LoadResultFile'')');
   h2 = uimenu(h_file, ...
           'Label','&Save Current Display to the IMG files', ...
   	   'Tag','SaveDisplayToIMG', ...
           'Callback','pet_result_sa_ui(''SaveDisplayToIMG'')'); 
   h2 = uimenu(h_file, ...
           'Label','&Save BLV to the IMG files', ...
   	   'Tag','SaveResultToIMG', ...
           'Callback','pet_result_sa_ui(''SaveResultToIMG'')');
   ...
   h2 = uimenu('Parent',h0, ...
   	   'Label','&Zoom on', ...
	   'Userdata', 1, ...
           'Callback','pet_result_sa_ui(''Zooming'')', ...
   	   'Tag','ZoomToggleMenu');
   ...
   h2 = uimenu('Parent',h_rot, ...
   	   ...
   	   'Checked','on', ...
           'Callback','pet_result_sa_ui(''Rotation'',1)', ...
   	   'Tag','Rotate0Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&90 degree', ...		% another 90 degree
   	   'Checked','off', ...
           'Callback','pet_result_sa_ui(''Rotation'',2)', ...
   	   'Tag','Rotate90Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&180 degree', ...		% now become 270 degree
   	   'Checked','off', ...
           'Callback','pet_result_sa_ui(''Rotation'',3)', ...
   	   'Tag','Rotate180Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&270 degree', ...		% now completed 360 degree
   	   'Checked','off', ...
           'Callback','pet_result_sa_ui(''Rotation'',0)', ...
   	   'Tag','Rotate270Menu');
   ...
   h2 = uimenu('Parent',h_view, ...
   	   'Label','&View Brain LV', ...
	   'Userdata', 1, ...
           'Callback','pet_result_sa_ui(''Toggle_View'')', ...
   	   'Tag','ViewToggleMenu');
   ...
   h2 = uimenu(h_pls, ...
           'Label','&Singular Values Plot', ...
     	   'Tag','OpenEigenPlot', ...
           'Callback','pet_result_sa_ui(''OpenEigenPlot'')');
   h2 = uimenu(h_pls, ...
           'Label','&Behavior LV and Behavior Scores Plot', ...
	   'Visible','off', ...
     	   'Tag','OpenBehavPlot', ...
           'Callback','pet_result_sa_ui(''OpenScoresPlot'',0)');
   h2 = uimenu(h_pls, ...
           'Label','&Design LV and Design Scores Plot', ...
	   'Visible','off', ...
     	   'Tag','OpenDesignPlot', ...
           'Callback','pet_result_sa_ui(''OpenScoresPlot'',1)');
   h2 = uimenu(h_pls, ...
           'Label','Task PLS Brain Scores with CI', ...
	   'Visible','off', ...
     	   'Tag','OpenBrainScoresPlot', ...
           'Callback','pet_result_sa_ui(''OpenBrainScoresPlot'')');
   h2 = uimenu(h_pls, ...
           'Label','B&rain Scores vs. Behavior Data Plot', ...
     	   'Tag','OpenBrainPlot', ...
           'Callback','pet_result_sa_ui(''OpenBrainPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Voxel Intensity Response', ...
     	   'Tag','OpenRFPlot', ...
           'Callback','pet_result_sa_ui(''OpenResponseFnPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Datamat Correlations Response', ...
     	   'Tag','OpenRF1Plot', ...
           'Callback','pet_result_sa_ui(''OpenCorrelationPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Datamat Correlations Plot', ...
     	   'Tag','OpenDatamatcorrsPlot', ...
           'Callback','pet_result_sa_ui(''OpenDatamatcorrsPlot'')'); 
   h2 = uimenu(h_pls, ...
   ...
   h2 = uimenu(h_pls, ...
           ...
           'Callback','pet_result_sa_ui(''OpenContrastWindow'')'); 
   h2 = uimenu(h_pls, ...
           'Label','Create Brain LV &Figure', ...
	   'separator', 'on', ...
   	   'Tag','PlotNewFigure', ...
           'Callback','pet_result_sa_ui(''PlotOnNewFigure'')');
   h2 = uimenu(h_pls, ...
   ...
   h2 = uimenu(h_pls, ...
           ...
           'Callback','pet_result_sa_ui(''SetClusterReportOptions'')');
   h2 = uimenu(h_pls, ...
           'Label','&Load Cluster Report', ...
     	   'Tag','LoadClsuterReport', ...
           'Callback','pet_result_sa_ui(''LoadClusterReport'')');
   h2 = uimenu(h_pls, ...
           'Label','&Create Cluster Report', ...
     	   'Tag','OpenClusterReport', ...
           'Callback','pet_result_sa_ui(''OpenClusterReport'')');
   h2 = uimenu(h_pls, ...
           'Label','Cluster Mask', ...
	   'separator', 'on', ...
           'check', 'off', ...
	   'Userdata', 1, ...
   	   'Tag','ClusterMask', ...
           'Callback','pet_result_sa_ui(''ClusterMask'')'); 
...
%   bs_thresh = cumulative_gaussian_inv(cumulated_p,0,std_ratio);
   ...
   if ~isempty(setting) & isfield(setting,'bs_thresh') ...
	...
	& ~isempty(setting.bs_thresh2{lv_idx})
      ...
      bs2_thresh = setting.bs_thresh2{lv_idx};
 ...
 %    pet_plot_cluster_mask(cluster_info);
  ...
  if (getappdata(gcf,'ViewBootstrapRatio') == 0),	% plot brain lv
	...
	return;
     ...
     switch action
       case {0}
          pet_plot_brainlv_sa(0,PLSresultFile,0,lv_idx,0,[],sa,cluster_info,update);
       case {1}
          pet_plot_brainlv_sa(0,PLSresultFile,0,lv_idx,1,[],sa,cluster_info,update);
     end
	...
	return;
     ...
     switch action
       case {0}
          pet_plot_brainlv_sa(1,PLSresultFile,0,lv_idx,0,[],sa,cluster_info,update);
       case {1}
          pet_plot_brainlv_sa(1,PLSresultFile,0,lv_idx,1,[],sa,cluster_info,update);
     end;
...
%  if ~isempty(cluster_info) & ~cluster_mask_state
 %    pet_plot_cluster_mask(cluster_info);
  ...
  taskpls_fig = getappdata(gcf,'taskplsHdl');

  if isempty(taskpls_fig)
      set(fig_hdl,'Pointer',old_pointer);
      return;
  else
      pet_plot_taskpls_bs('UPDATE_LV_SELECTION',taskpls_fig,lv_idx);
      set(taskpls_fig,'Pointer',old_pointer);
      set(fig_hdl,'Pointer',old_pointer);
  end;
