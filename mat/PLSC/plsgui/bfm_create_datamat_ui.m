...
%   y = y+.01;
   ...
   c = uicontrol('Parent',h0, ...		% Number of skipped scans edit
	...
	'visible','off', ...
   	...
   	'Callback','bfm_create_datamat_ui(''EDIT_SKIPPED_SCANS'');', ...
...
%   y = y+.01;
   ...
   c = uicontrol('Parent',h0, ...		%  Datamat Run Included Edit
	...
	'visible','off',...
   	...
   	'Callback','bfm_create_datamat_ui(''EDIT_RUN_INCLUDED'');', ...
...
%   y = y+.01;
   ...
   c = uicontrol('Parent',h0, ...		% Ignore Slices Edit 
	...
	'visible','off',...
   	...
   	'Callback','bfm_create_datamat_ui(''EDIT_IGNORE_SLICES'');', ...
   	'Tag','DatamatIgnoreSlicesEdit');
...
%   y = y+.01;
   ...
   c = uicontrol('Parent',h0, ...		% Window Size Edit 
	...
	'visible','off', ...
        'TooltipString','Enter a positive integer.', ...
   	'Callback','bfm_create_datamat_ui(''EDIT_TEMPORAL_WINDOW_SIZE'');', ...
   	'Tag','DatamatWindowSizeEdit');
...
%   y = y-.04;
   ...
   c = uicontrol('Parent',h0, ...		% Merge Data Across Runs Button
	...
	'visible', 'off', ...
   	'Callback','bfm_create_datamat_ui(''MERGE_DATA_ACROSS_RUNS_BUTTON'');', ...
   ...
   c = uicontrol('Parent',h0, ...		% Merge Data Within Run Button
	...
	'visible', 'off', ...
   	'Callback','bfm_create_datamat_ui(''MERGE_DATA_WITH_RUN_BUTTON'');', ...
...
%   y = y-.05;
   ...
   c = uicontrol('Parent',h0, ...		% Single Subject
	...
	'fontunit','normal', ...
   	...
   	'Callback','bfm_create_datamat_ui(''SINGLESUBJECTBUTTON'');', ...
   ...
   c = uicontrol('Parent',h0, ...		% Single Reference Scan
	...
	'fontunit','normal', ...
   	...
   	'Callback','bfm_create_datamat_ui(''SingleRefScanButton'');', ...
   ...
   c = uicontrol('Parent',h0, ...		% single ref scan onset edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'String','0', ...
   	'Callback','bfm_create_datamat_ui(''SingleRefScanOnsetEdit'');', ...
	'enable', 'off', ...
   ...
   c = uicontrol('Parent',h0, ...		% single ref scan number edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'String','1', ...
   	'Callback','bfm_create_datamat_ui(''SingleRefScanNumberEdit'');', ...
	'enable', 'off', ...
   ...
   c = uicontrol('Parent',h0, ...		% Number of behavior edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'String','0', ...
   	'buttondown','bfm_create_datamat_ui(''EDIT_NUM_BEHAVIOR'');', ...
	'enable', 'inactive', ...
	'visible', 'off', ...
   ...
   c = uicontrol('Parent',h0, ...		% Behavior Data Edit
	...
	'string', 'Edit Behavior Data...', ...
   	...
   	'FontSize',fnt, ...
   	'Position',pos, ...
	'callback','bfm_create_datamat_ui(''EDIT_BEHAV_DATA_ALL'');', ...
	'enable', 'on', ...
	'visible', 'off', ...
   ...
   c = uicontrol('Parent',h0, ...		% Behavior Data Edit
	...
	'string', 'Edit Behavior Data...', ...
   	...
   	'FontSize',fnt, ...
   	'Position',pos, ...
	'callback','bfm_create_datamat_ui(''EDIT_BEHAV_DATA_EACH'');', ...
	'enable', 'on', ...
	'visible','off', ...
   ...
   c = uicontrol('Parent',h0, ...		% Behavior Data Edit
	...
	'string', 'Edit Behavior Data...', ...
   	...
   	'FontSize',fnt, ...
   	'Position',pos, ...
	'callback','bfm_create_datamat_ui(''EDIT_BEHAV_DATA_ALL_SINGLE'');', ...
	'enable', 'on', ...
	'visible','off', ...
   ...
   c = uicontrol('Parent',h0, ...		% Behavior Data Edit
	...
	'string', 'Edit Behavior Data...', ...
   	...
   	'FontSize',fnt, ...
   	'Position',pos, ...
	'callback','bfm_create_datamat_ui(''EDIT_BEHAV_DATA_EACH_SINGLE'');', ...
	'enable', 'on', ...
	'visible','off', ...
   ...
   c = uicontrol('Parent',h0, ...		% Behav Data Button
   	...
   	'FontSize',fnt, ...
        'Position',pos, ...
        'String','Browse ...', ...
   	'Callback','bfm_create_datamat_ui(''SELECT_BEHAV_DATA'');', ...
	'enable', 'on', ...
	'visible', 'off', ...
   	'Tag','BehavDataButton');
...
%   h = 0.04;
   ...
   c = uicontrol('Parent',h0, ...		% RUN Button
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'String','Create', ...
   	'Callback','bfm_create_datamat_ui(''RUN_BUTTON'');',...
   	'Tag','RUNButton');
...
%   x = 1-x-w;
   ...
   c = uicontrol('Parent',h0, ...		% CANCEL Button
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'String','Cancel', ...
   	'Callback','bfm_create_datamat_ui(''CANCEL_BUTTON'');',...
   	'Tag','CANCELButton');
