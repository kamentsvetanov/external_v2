function fig = pet_plot_datamatcorrs_3v(action,varargin)
...
%      pet_plot_datamatcorrs_3v('Rotation', rot_amount);
      ShowResult(0,0);
   ...
   elseif (strcmp(action,'DeleteNewFigure'))
      try
         ...
         pet_plot_datamatcorrs_3v_newfig_pos = get(gcbf,'position');

         save(pls_profile, '-append', 'pet_plot_datamatcorrs_3v_newfig_pos');
      catch
      end
   elseif (strcmp(action,'DeleteFigure'))
     try
        ...
        pet_plot_datamatcorrs_3v_pos = get(gcbf,'position');

        save(pls_profile, '-append', 'pet_plot_datamatcorrs_3v_pos');
     catch
     end
...
%     set(calling_fig,'visible','on');
   ...
   elseif (strcmp(action,'LoadClusterReport'))
     pet_cluster_report('LoadClusterReport',gcbf);
...
function h0 = init(PLSResultFile);
   ...
   if ~isempty(pet_plot_datamatcorrs_3v_pos) & strcmp(save_setting_status,'on')

      pos = pet_plot_datamatcorrs_3v_pos;
...
%   [r_path,r_file,r_ext] = fileparts(PLSResultFile);
   ...
   h0 = figure('Units','normal', ...
   	...
   	'MenuBar','none',...
   	'Position',pos, ...
   	'DeleteFcn','pet_plot_datamatcorrs_3v(''DeleteFigure'')', ...
   	'Tag','PlotBrainLV');
   %
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','pet_plot_datamatcorrs_3v(''EditGroup'')', ...
   	'Tag','GroupIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...			% lv index edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','pet_plot_datamatcorrs_3v(''EditLV'')', ...
   	'Tag','LVIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...			% behav index edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','pet_plot_datamatcorrs_3v(''EditBehav'')', ...
   	'Tag','BehavIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...			% threshold edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
        'Callback','pet_plot_datamatcorrs_3v(''PlotBnPress'')', ...
   	'Tag','Threshold');
   ...
   h1 = uicontrol('Parent',h0, ...			% lv index edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','pet_plot_datamatcorrs_3v(''EditBSLV'')', ...
   	'Tag','BSLVIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','pet_plot_datamatcorrs_3v(''UpdatePValue'')', ...
   	'Tag','BSThreshold');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'ToolTipString','Click to select the XYZ you entered', ...
   	'Style','push', ...
   	'Callback','pet_plot_datamatcorrs_3v(''EditXYZ'')');
   ...
   h1 = uicontrol('Parent',h0, ...			% Origin text
	...
	'ToolTipString','Voxel coordinates w.r.t. the origin', ...
   	'Style','edit', ...
   	'Callback','pet_plot_datamatcorrs_3v(''EditXYZmm'')', ...
   	'Tag','XYZmm');
   ...
   h2 = uimenu(h_file, ...
           ...
           'Tag','LoadBGImage', ...
           'Callback','pet_plot_datamatcorrs_3v(''LoadBackgroundImage'')');
   h2 = uimenu(h_file, ...
           'Label','Save brain region to IMG file', ...
   	   'Tag','SaveBGImage', ...
           'Callback','pet_plot_datamatcorrs_3v(''SaveBackgroundImage'')');
   h2 = uimenu(h_file, ...
           'Label','&Load PLS Result', ...
   	   'Tag','LoadPETResult', ...
		'visible', 'off', ...
           'Callback','pet_plot_datamatcorrs_3v(''LoadResultFile'')');
   h2 = uimenu(h_file, ...
           'Label','&Save Current Display to the IMG files', ...
   	   'Tag','SaveDisplayToIMG', ...
           'Callback','pet_plot_datamatcorrs_3v(''SaveDisplayToIMG'')'); 
   h2 = uimenu(h_file, ...
           'Label','&Save DatamatCorrelation to IMG file', ...
   	   'Tag','SaveResultToIMG', ...
           'Callback','pet_plot_datamatcorrs_3v(''SaveResultToIMG'')');
   h2 = uimenu(h_file, ...
           'Label','Create Datamat Correlations &Figure', ...
   	   'Tag','PlotNewFigure', ...
           'Callback','pet_plot_datamatcorrs_3v(''PlotOnNewFigure'')');
   ...
   h2 = uimenu('Parent',h0, ...
   	   'Label','&Zoom on', ...
	   'Userdata', 1, ...
           'Callback','pet_plot_datamatcorrs_3v(''Zooming'')', ...
   	   'Tag','ZoomToggleMenu');
   ...
   h2 = uimenu('Parent',h_rot, ...
   	   ...
   	   'Checked','on', ...
           'Callback','pet_plot_datamatcorrs_3v(''Rotation'',1)', ...
   	   'Tag','Rotate0Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&90 degree', ...		% another 90 degree
   	   'Checked','off', ...
           'Callback','pet_plot_datamatcorrs_3v(''Rotation'',2)', ...
   	   'Tag','Rotate90Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&180 degree', ...		% now become 270 degree
   	   'Checked','off', ...
           'Callback','pet_plot_datamatcorrs_3v(''Rotation'',3)', ...
   	   'Tag','Rotate180Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&270 degree', ...		% now completed 360 degree
   	   'Checked','off', ...
           'Callback','pet_plot_datamatcorrs_3v(''Rotation'',0)', ...
   	   'Tag','Rotate270Menu');
   ...
   h2 = uimenu(h_pls, ...
           'Label','&Singular Values Plot', ...
     	   'Tag','OpenEigenPlot', ...
           'Callback','pet_plot_datamatcorrs_3v(''OpenEigenPlot'')');
   h2 = uimenu(h_pls, ...
           'Label','&Behavior LV and Behavior Scores Plot', ...
	   'Visible','off', ...
     	   'Tag','OpenBehavPlot', ...
           'Callback','pet_plot_datamatcorrs_3v(''OpenScoresPlot'',0)');
   h2 = uimenu(h_pls, ...
           'Label','&Design LV and Design Scores Plot', ...
	   'Visible','off', ...
     	   'Tag','OpenDesignPlot', ...
           'Callback','pet_plot_datamatcorrs_3v(''OpenScoresPlot'',1)');
   h2 = uimenu(h_pls, ...
           'Label','B&rain Scores vs. Behavior Data Plot', ...
     	   'Tag','OpenBrainPlot', ...
           'Callback','pet_plot_datamatcorrs_3v(''OpenBrainPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Voxel Intensity Response', ...
     	   'Tag','OpenRFPlot', ...
           'Callback','pet_plot_datamatcorrs_3v(''OpenResponseFnPlot'')'); 
   h2 = uimenu(h_pls, ...
   ...
   h2 = uimenu(h_pls, ...
           ...
           'Callback','pet_plot_datamatcorrs_3v(''OpenDatamatcorrsPlot'')'); 
   h2 = uimenu(h_pls, ...
   ...
   h2 = uimenu(h_pls, ...
           ...
           'Callback','pet_plot_datamatcorrs_3v(''SetClusterReportOptions'')');
   h2 = uimenu(h_pls, ...
           'Label','&Load Cluster Report', ...
     	   'Tag','LoadClsuterReport', ...
           'Callback','pet_plot_datamatcorrs_3v(''LoadClusterReport'')');
   h2 = uimenu(h_pls, ...
           'Label','&Create Cluster Report', ...
     	   'Tag','OpenClusterReport', ...
           'Callback','pet_plot_datamatcorrs_3v(''OpenClusterReport'')');
...
function OpenClusterReport()
   ...
   pet_cluster_report(cluster_min_size,cluster_min_dist);
...
%     pet_create_colorbar(colorbar_hdl,cbar,min_ratio,max_ratio);
  ...
  set(h_img,'ButtonDownFcn','pet_plot_datamatcorrs_3v(''SelectPixel'')');
%  pet_create_colorbar( colorbar_hdl, cbar, min_ratio, max_ratio );
...
%
  ...
  if (getappdata(gcf,'ViewBootstrapRatio') == 0),	% plot brain lv
     ...
     switch action
       case {0}
          pet_plot_brainlv_3v(0,PLSresultFile,grp_idx,lv_idx,0,behav_idx,[],update);
       case {1}
          pet_plot_brainlv_3v(0,PLSresultFile,grp_idx,lv_idx,1,behav_idx,[],update);
     end
     ...
     switch action
       case {0}
          pet_plot_brainlv_3v(2,PLSresultFile,grp_idx,lv_idx,0,behav_idx,[],update);
       case {1}
          pet_plot_brainlv_3v(2,PLSresultFile,grp_idx,lv_idx,1,behav_idx,[],update);
     end;
...
function OpenDatamatcorrsPlot
   ...
   datamatcorrs_fig = pet_plot_datamatcorrs_3v;
