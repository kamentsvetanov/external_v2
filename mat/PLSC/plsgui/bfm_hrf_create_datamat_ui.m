function bfm_hrf_create_datamat_ui(varargin) 
% 
%  USAGE:  bfm_hrf_create_datamat_ui(session_file,num_runs,num_slices) 
% 
%  bfm_hrf_create_datamat_ui - create datatmat options GUI 
% 
...
%         uiresume(gcf);
   ...
   elseif strcmp(action,'EDIT_LEGENDRE')
      Edit_Legendre;
   elseif strcmp(action,'EDIT_TR')
      Edit_TR;
   elseif strcmp(action,'RUN_HRF')
      session_info = getappdata(gcf,'SessionFile');
      Design_Matrix = getappdata(gcf,'Design_Matrix');
      hrf_cond_plot(session_info, Design_Matrix);
   elseif strcmp(action,'HRF_WITH_BIN')
      hrf_with_bin;
   elseif strcmp(action,'DEFAULT_SPM')
      default_spm;
   elseif strcmp(action,'CUSTOMIZE_HRF1')
      customize_hrf1;
   elseif strcmp(action,'SAVE_HRF')
      hrf = getappdata(gcf,'HRF');

      if isempty(hrf) | ~isnumeric(hrf)
         msg = 'HRF must be numeric value';
         uiwait(msgbox(msg,'Wrong Data','modal'));
         return;
      end

      [f p] = selectafile('*.txt', 'Save HRF to a 1-D text data');
      if p==0, return; end

      save(fullfile(p,f), '-ascii', 'hrf');
   elseif strcmp(action,'HRF_NO_BIN')
      hrf_no_bin;
   elseif strcmp(action,'DEFAULT_GAMMA')
      default_gamma;
   elseif strcmp(action,'CUSTOMIZE_HRF2')
      customize_hrf2;
   end;
...
%      h = 0.9;
   ...
   h0 = figure( ...
   	...
   	'Units','normal', ...
        ...
        'NumberTitle','off', ...
   	'Position', pos, ...
        'deleteFcn','bfm_hrf_create_datamat_ui(''DELETE_FIGURE'');', ...
        'Menubar', 'none', ...
        'WindowStyle','modal', ...
   	'Tag','DatamatOptions', ...
   	'ToolBar','none');
...
%   y = y-.04;
   ...
   c = uicontrol('Parent',h0, ...		% Predefine Region Button
	...
	'fontunit','normal', ...
   	...
   	'String','', ...
   	'Callback', ...
             'bfm_hrf_create_datamat_ui(''PREDEFINE_BRAIN_REGION_BUTTON'');', ...
...
%   y = y-.05;
   ...
   c = uicontrol('Parent',h0, ...		% Predefine Region File Edit
	...
	'fontunit','normal', ...
   	...
   	'String','', ...
        'Enable','off', ...
   	'Callback','bfm_hrf_create_datamat_ui(''EDIT_BRAIN_REGION_FILE'');',...
   ...
   c = uicontrol('Parent',h0, ...		% Predefine Region File Button
	...
	'fontunit','normal', ...
        ...
        'String','Browse', ...
        'Enable','off', ...
   	'Callback', 'bfm_hrf_create_datamat_ui(''BRAIN_REGION_FILE_BUTTON'');', ...
...
%   y = y-.05;
   ...
   c = uicontrol('Parent',h0, ...               % Auto Region Button
	...
	'fontunit','normal', ...
        ...
        'Position',pos, ...
        'String','', ...
   	'Callback','bfm_hrf_create_datamat_ui(''AUTO_BRAIN_REGION_BUTTON'');', ...
...
%   y = y-.05;
   ...
   c = uicontrol('Parent',h0, ...		% Auto Region Threshold Edit
	...
	'fontunit','normal', ...
   	...
   	'Callback','bfm_hrf_create_datamat_ui(''SET_THRESHOLD'');', ...
   ...
   c = uicontrol('Parent',h0, ...		% Consider all voxels as brain
	...
	'fontunit','normal', ...
   	...
   	'Callback','bfm_hrf_create_datamat_ui(''CONSIDER_ALL_VOXELS'');', ...
...
%   y = y-.05-.01;
   ...
   c = uicontrol('Parent',h0, ...		% Brain Region Max SD Edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'String','4', ...
   	'Callback','bfm_hrf_create_datamat_ui(''SET_MAX_STD_DEVIATION'');', ...
	'visible', 'off', ...
...
%   y = y-.05;
   ...
   c = uicontrol('Parent',h0, ...		% Number of skipped scans edit
	...
	'visible','off',...
   	...
   	'Callback','bfm_hrf_create_datamat_ui(''EDIT_SKIPPED_SCANS'');', ...
...
%   y = y-.05-.01;
   ...
   c = uicontrol('Parent',h0, ...		% Datamat Run Included Label
   	'Style','text', ...
   	'Units','normal', ...
   	'BackgroundColor',[0.7 0.7 0.7], ...
	'fontunit','normal', ...
   	...
   	'String','Run to be included:', ...
        'TooltipString','The indices of the runs to be used to generate the Datamat.', ...
	'visible','off',...
   	'Tag','DatamatRunIncludedLabel');
   ...
   c = uicontrol('Parent',h0, ...		%  Datamat Run Included Edit
   	'Style','edit', ...
   	'Units','normal', ...
   	'BackgroundColor',[1 1 1], ...
	'fontunit','normal', ...
   	...
   	'Callback','bfm_hrf_create_datamat_ui(''EDIT_RUN_INCLUDED'');', ...
	'visible','off',...
   	'Tag','DatamatRunIncludedEdit');
...
%   y = y-.05;
   ...
   c = uicontrol('Parent',h0, ...		% Use SPM ReML
   	'Style','checkbox', ...
   	'Units','normal', ...
   	'BackgroundColor',[0.7 0.7 0.7], ...
	'fontunit','normal', ...
   ...
   c = uicontrol('Parent',h0, ...		% Legendre Label
   	'Style','text', ...
   	'Units','normal', ...
   	'BackgroundColor',[0.7 0.7 0.7], ...
	'fontunit','normal', ...
   	...
   	'HorizontalAlignment','left', ...
   	'Position',pos, ...
   	'String','Degree of Legendre Polynomials for regressors:', ...
   	'Tag','LegendreLabel');
   ...
   c = uicontrol('Parent',h0, ...		% Legendre Edit
   	'Style','edit', ...
   	'Units','normal', ...
   	'BackgroundColor',[1 1 1], ...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'String','0', ...
   	'Callback','bfm_hrf_create_datamat_ui(''EDIT_Legendre'');', ...
   	'Tag','LegendreEdit');
   ...
   %-------- for HRF frame
   c = uicontrol('Parent',h0, ...		% HRF Frame
   	'Units','normal', ...
   	'Style','frame', ...
   	'BackgroundColor',[0.7 0.7 0.7], ...
   	'Position',pos, ...
   ...
   c = uicontrol('Parent',h0, ...		% HRF Label
   	'Style','text', ...
   	'Units','normal', ...
   	'BackgroundColor',[0.7 0.7 0.7], ...
	'fontunit','normal', ...
   ...
   c = uicontrol('Parent',h0, ...		% TR Label
   	'Style','text', ...
   	'Units','normal', ...
   	'BackgroundColor',[0.7 0.7 0.7], ...
	'fontunit','normal', ...
   ...
   c = uicontrol('Parent',h0, ...		% TR Edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'String','', ...
   	'Callback','bfm_hrf_create_datamat_ui(''EDIT_TR'');', ...
   	'Tag','TREdit');
   ...
   c = uicontrol('Parent',h0, ...		% HRF for Run
   	'Style','pushbutton', ...
   	'Units','normal', ...
	'fontunit','normal', ...
   	'FontSize',fnt, ...
   	'HorizontalAlignment','center', ...
   	'Position',pos, ...
   	'String','Plot Regressors', ...
   	'Callback','bfm_hrf_create_datamat_ui(''Run_HRF'');',...
	'enable','off', ...
   	'Tag','RunHRF');
   ...
   c = uicontrol('Parent',h0, ...		% TR will be further divided when calculating design matrix
   	'Style','radio', ...
   	'Units','normal', ...
   	'BackgroundColor',[0.7 0.7 0.7], ...
	'fontunit','normal', ...
	...
	'enable', 'off', ...
   	'Position', pos, ...
   	'String','HRF1', ...
   	'Callback', 'bfm_hrf_create_datamat_ui(''HRF_with_bin'');', ...
   	'Tag','HRF_with_bin');
   ...
   c = uicontrol('Parent',h0, ...		% Default SPM
   	'Style','checkbox', ...
   	'Units','normal', ...
   	'BackgroundColor',[0.7 0.7 0.7], ...
	'fontunit','normal', ...
	...
	'enable', 'off', ...
   	'Position', pos, ...
   	'String','Use SPM HRF', ...
   	'Callback', 'bfm_hrf_create_datamat_ui(''Default_SPM'');', ...
   	'Tag','DefaultSPM');
   ...
   c = uicontrol('Parent',h0, ...		% Customize HRF1
   	'Style','pushbutton', ...
   	'Units','normal', ...
	'fontunit','normal', ...
   	'FontSize',fnt, ...
   	'HorizontalAlignment','center', ...
   	'Position',pos, ...
   	'String','Customize HRF1', ...
   	'Callback','bfm_hrf_create_datamat_ui(''Customize_HRF1'');',...
	'enable','off', ...
   	'Tag','CustomizeHRF1');
   ...
   c = uicontrol('Parent',h0, ...		% Save HRF1
   	'Style','pushbutton', ...
   	'Units','normal', ...
	'fontunit','normal', ...
   	'FontSize',fnt, ...
   	...
   	'Position',pos, ...
   	'String','Save HRF1', ...
   	'Callback','bfm_hrf_create_datamat_ui(''Save_HRF'');',...
	'enable','off', ...
   	'Tag','SaveHRF1');
   ...
   c = uicontrol('Parent',h0, ...		% TR is always the smallest unit when calculating design matrix
   	'Style','radio', ...
   	'Units','normal', ...
   	'BackgroundColor',[0.7 0.7 0.7], ...
	'fontunit','normal', ...
	...
	'enable', 'off', ...
   	'Position', pos, ...
   	'String','HRF2', ...
   	'Callback', 'bfm_hrf_create_datamat_ui(''HRF_no_bin'');', ...
   	'Tag','HRF_no_bin');
   ...
   c = uicontrol('Parent',h0, ...		% Default GAMMA
   	'Style','checkbox', ...
   	'Units','normal', ...
   	'BackgroundColor',[0.7 0.7 0.7], ...
	'fontunit','normal', ...
	...
	'enable', 'off', ...
   	'Position', pos, ...
   	'String','Use GAMMA HRF', ...
   	'Callback', 'bfm_hrf_create_datamat_ui(''Default_GAMMA'');', ...
   	'Tag','DefaultGAMMA');
   ...
   c = uicontrol('Parent',h0, ...		% Customize HRF2
   	'Style','pushbutton', ...
   	'Units','normal', ...
	'fontunit','normal', ...
   	'FontSize',fnt, ...
   	'HorizontalAlignment','center', ...
   	'Position',pos, ...
   	'String','Customize HRF2', ...
   	'Callback','bfm_hrf_create_datamat_ui(''Customize_HRF2'');',...
	'enable','off', ...
   	'Tag','CustomizeHRF2');
   ...
   c = uicontrol('Parent',h0, ...		% Save HRF2
   	'Style','pushbutton', ...
   	'Units','normal', ...
	'fontunit','normal', ...
   	'FontSize',fnt, ...
...
%   h = 0.04;
   ...
   c = uicontrol('Parent',h0, ...		% ORIENT Button
	...
	'fontunit','normal', ...
   	...
   	'Callback','bfm_hrf_create_datamat_ui(''ORIENT'');',...
   	'Tag','ORIENTButton');
...
%   h = 0.04;
   ...
   c = uicontrol('Parent',h0, ...		% RUN Button
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'String','Create', ...
   	'Callback','bfm_hrf_create_datamat_ui(''RUN_BUTTON'');',...
   	'Tag','RUNButton');
...
%   x = 1-x-w;
   ...
   c = uicontrol('Parent',h0, ...		% CANCEL Button
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'String','Cancel', ...
   	'Callback','bfm_hrf_create_datamat_ui(''CANCEL_BUTTON'');',...
   	'Tag','CANCELButton');
...
function InitOptions(num_runs)
   ...
   setappdata(gcf,'TemporalWindowSize',1);
   setappdata(gcf,'Legendre',0);
...
return;
   ...
   if isempty(num_scans_skipped) | (num_scans_skipped < 0)
      num_scans_skipped = getappdata(gcf,'NumScansSkipped');
      set(findobj(gcf,'Tag','NumScansSkippedEdit'),'string',num2str(num_scans_skipped))
   ...
   load(getappdata(gcf,'SessionFile'));

   for i = 1:session_info.num_runs
      ons = session_info.run(i).evt_onsets;
      dur = session_info.run(i).blk_length;
      Design_Matrix{i} = hrf_get_design_matrix(hrf, ons, dur, session_info.run(i).num_scans, TR, num_scans_skipped);
   end
...
function status = SaveDatamatOptions()
   ...
   h = findobj(gcbf,'Tag','Use_SPM_ReML');
   STOptions.UseReML = get(h,'Value'); 
...
%   STOptions.SingleRefScanButton = get(findobj(gcf,'Tag','SingleRefScanButton'), 'value');
 %  STOptions.SingleRefScanOnset = str2num(get(findobj(gcf,'Tag','SingleRefScanOnsetEdit'), 'string'));
  % STOptions.SingleRefScanNumber = str2num(get(findobj(gcf,'Tag','SingleRefScanNumberEdit'), 'string'));
   ...
   STOptions.Legendre = getappdata(gcf,'Legendre');
   if isempty(STOptions.Legendre) 
      msg = 'ERROR: Invalid Degree of Legendre Polynomials.';
      set(findobj(gcf,'Tag','MessageLine'),'String',msg);
      return;
   end;

   STOptions.TR = getappdata(gcf,'TR');
   if isempty(STOptions.TR) 
      msg = 'ERROR: Invalid TR value.';
      set(findobj(gcf,'Tag','MessageLine'),'String',msg);
      return;
   end;

   STOptions.HRF = getappdata(gcf,'HRF');
   if isempty(STOptions.HRF) 
      msg = 'ERROR: Invalid HRF.';
      set(findobj(gcf,'Tag','MessageLine'),'String',msg);
      return;
   end;

   STOptions.Design_Matrix = getappdata(gcf,'Design_Matrix');
   if isempty(STOptions.Design_Matrix) 
      msg = 'ERROR: Invalid HRF for Run.';
      set(findobj(gcf,'Tag','MessageLine'),'String',msg);
      return;
   end;
...
%          fmri_gen_datamat(session_file,i,options.BrainRegionFile, ...
          bfm_hrf_get_datamat(session_file,i,options.BrainRegionFile, ...
					options.MaxStdDev, ...
					...
					options.TR, ...
					options.HRF, ...
					options.Design_Matrix, ...
					orient);
       else
%          fmri_gen_datamat(session_file,i,options.Threshold, ...
          bfm_hrf_get_datamat(session_file,i,options.Threshold, ...
					options.MaxStdDev, ...
					options.SliceIgnored, ...
					options.NormalizeVolumeMean, ...
					options.NumScansSkipped, ...
...
function Edit_Legendre

   Legendre = str2num(get(findobj(gcf,'Tag','LegendreEdit'),'string'));

   if isempty(Legendre) | ~isnumeric(Legendre)
      Legendre = getappdata(gcf,'Legendre');
      set(findobj(gcf,'Tag','LegendreEdit'),'string',num2str(Legendre))
      msg = 'Degree of Legendre Polynomials must be numeric value';
      set(findobj(gcf,'Tag','MessageLine'),'String',msg);
      return;
   end
   ...
   if Legendre < 0
      Legendre = getappdata(gcf,'Legendre');
      set(findobj(gcf,'Tag','LegendreEdit'),'string',num2str(Legendre))
      msg = 'Degree of Legendre Polynomials must be non-negative';
      set(findobj(gcf,'Tag','MessageLine'),'String',msg);
      return;
   end

   return;						% Edit_Legendre

%----------------------------------------------------------------------------

function Edit_TR

   TR = str2num(get(findobj(gcf,'Tag','TREdit'),'string'));

   if isempty(TR) | ~isnumeric(TR)
      TR = getappdata(gcf,'TR');
      set(findobj(gcf,'Tag','TREdit'),'string',num2str(TR))
      msg = 'TR must be numeric value';
      set(findobj(gcf,'Tag','MessageLine'),'String',msg);
      return;
   end
   ...
   if TR <= 0
      TR = getappdata(gcf,'TR');
      set(findobj(gcf,'Tag','TREdit'),'string',num2str(TR))
      msg = 'TR must be a positive value';
      set(findobj(gcf,'Tag','MessageLine'),'String',msg);
      return;
   end

   if get(findobj(gcf,'Tag','HRF_no_bin'),'value')

      old_pointer = get(gcf,'Pointer');
      set(gcf,'Pointer','watch');

      hrf = hrf_gamma_hrf(TR);
      ...
      for i = 1:session_info.num_runs
         ons = session_info.run(i).evt_onsets;
         dur = session_info.run(i).blk_length;
         Design_Matrix{i} = hrf_get_design_matrix2(hrf, ons, dur, session_info.run(i).num_scans, TR, session_info.run(i).num_scans_skipped);
      end

      setappdata(gcf,'TR',TR);
      setappdata(gcf,'HRF',hrf);
      setappdata(gcf,'Design_Matrix',Design_Matrix);

      set(gcf,'Pointer',old_pointer);


      set(findobj(gcf,'Tag','HRF_with_bin'),'enable','on','value',0);
      set(findobj(gcf,'Tag','HRF_no_bin'),'enable','on','value',1);
      set(findobj(gcf,'Tag','CustomizeHRF1'),'enable','off');
      set(findobj(gcf,'Tag','CustomizeHRF2'),'enable','on');
      set(findobj(gcf,'Tag','SaveHRF1'),'enable','off');
      set(findobj(gcf,'Tag','SaveHRF2'),'enable','on');

      msg = 'FYI - HRF2: TR is always the smallest unit when calculating design matrix';
      set(findobj(gcf,'Tag','MessageLine'),'String',msg);
   else
      ...
      for i = 1:session_info.num_runs
         ons = session_info.run(i).evt_onsets;
         dur = session_info.run(i).blk_length;
         Design_Matrix{i} = hrf_get_design_matrix(hrf, ons, dur, session_info.run(i).num_scans, TR, session_info.run(i).num_scans_skipped);
      end
      ...
      set(findobj(gcf,'Tag','HRF_with_bin'),'enable','on','value',1);
      set(findobj(gcf,'Tag','HRF_no_bin'),'enable','on','value',0);
      set(findobj(gcf,'Tag','CustomizeHRF1'),'enable','on');
      set(findobj(gcf,'Tag','CustomizeHRF2'),'enable','off');
      set(findobj(gcf,'Tag','SaveHRF1'),'enable','on');
      set(findobj(gcf,'Tag','SaveHRF2'),'enable','off');

      msg = 'FYI - HRF1: TR will be further divided when calculating design matrix';
      set(findobj(gcf,'Tag','MessageLine'),'String',msg);
   end

   set(findobj(gcf,'Tag','RunHRF'),'enable','on');

   return;						% Edit_TR

%----------------------------------------------------------------------------

function hrf_with_bin

   if get(findobj(gcf,'Tag','HRF_with_bin'),'Value') == 0	% click itself
      set(findobj(gcf,'Tag','HRF_with_bin'),'Value',1);
      return;
   else
      set(findobj(gcf,'Tag','HRF_with_bin'),'enable','on','value',1);
      set(findobj(gcf,'Tag','HRF_no_bin'),'enable','on','value',0);
      ...
      set(findobj(gcf,'Tag','DefaultSPM'),'value',1,'enable','off');
      set(findobj(gcf,'Tag','DefaultGAMMA'),'value',1,'enable','off');
      TR = getappdata(gcf,'TR');
...
function default_spm
   ...
   set(gcf,'Pointer',old_pointer);
   set(findobj(gcf,'Tag','DefaultSPM'),'enable','off');

   return;					% default_spm

%----------------------------------------------------------------------------

function customize_hrf1

   hrf = getappdata(gcf,'HRF');
   hrf2 = edit_1d_data1(hrf, 'HRF Editor', length(hrf));
   ...
   if ~isequal(hrf,hrf0)
      set(findobj(gcf,'Tag','DefaultSPM'),'enable','on','value',0);
   ...
   return;					% customize_hrf1

%----------------------------------------------------------------------------

function hrf_no_bin

   if get(findobj(gcf,'Tag','HRF_no_bin'),'Value') == 0	% click itself
      set(findobj(gcf,'Tag','HRF_no_bin'),'Value',1);
      return;
   else
      set(findobj(gcf,'Tag','HRF_with_bin'),'enable','on','value',0);
      set(findobj(gcf,'Tag','HRF_no_bin'),'enable','on','value',1);
...
function default_gamma
   ...
   set(gcf,'Pointer',old_pointer);
   set(findobj(gcf,'Tag','DefaultGAMMA'),'enable','off');

   return;					% default_gamma

%----------------------------------------------------------------------------

function customize_hrf2

   hrf = getappdata(gcf,'HRF');
   hrf2 = edit_1d_data(hrf, 'HRF Editor', length(hrf));
   ...
   TR = getappdata(gcf,'TR');
   hrf0 = hrf_gamma_hrf(TR);

   if ~isequal(hrf,hrf0)
      set(findobj(gcf,'Tag','DefaultGAMMA'),'enable','on','value',0);
