function fig = bfm_plot_datamatcorrs_3v(action,varargin)
...
%      bfm_plot_datamatcorrs_3v('Rotation', rot_amount);
      ShowResult(0,0);
   ...
   elseif (strcmp(action,'DeleteNewFigure'))
      try
         ...
         bfm_plot_datamatcorrs_3v_newfig_pos = get(gcbf,'position');

         save(pls_profile, '-append', 'bfm_plot_datamatcorrs_3v_newfig_pos');
      catch
      end
   elseif (strcmp(action,'DeleteFigure'))
      try
         ...
         bfm_plot_datamatcorrs_3v_pos = get(gcbf,'position');

         save(pls_profile, '-append', 'bfm_plot_datamatcorrs_3v_pos');
      catch
      end
...
function h0 = init(PLSResultFile);
   ...
   if ~isempty(bfm_plot_datamatcorrs_3v_pos) & strcmp(save_setting_status,'on')

      pos = bfm_plot_datamatcorrs_3v_pos;
...
%   [r_path,r_file,r_ext] = fileparts(PLSResultFile);
   ...
   h0 = figure('Units','normal', ...
   	...
   	'MenuBar','none',...
   	'Position',pos, ...
   	'DeleteFcn','bfm_plot_datamatcorrs_3v(''DeleteFigure'')', ...
   	'Tag','PlotBrainLV');
   %
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','bfm_plot_datamatcorrs_3v(''EditGroup'')', ...
   	'Tag','GroupIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','bfm_plot_datamatcorrs_3v(''EditLV'')', ...
   	'Tag','LVIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...			% behav index edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','bfm_plot_datamatcorrs_3v(''EditBehav'')', ...
   	'Tag','BehavIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
        'Callback','bfm_plot_datamatcorrs_3v(''PlotBnPress'')', ...
   	'Tag','Threshold');
   ...
   h1 = uicontrol('Parent',h0, ...			% lv index edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','bfm_plot_datamatcorrs_3v(''EditBSLV'')', ...
   	'Tag','BSLVIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','bfm_plot_datamatcorrs_3v(''UpdatePValue'')', ...
   	'Tag','BSThreshold');
...
%
  ...
  if (getappdata(gcf,'ViewBootstrapRatio') == 0),	% plot brain lv 
     ...
     switch action 
       case {0}
          bfm_plot_brainlv_3v(0,PLSresultFile,grp_idx,lv_idx,0,behav_idx,[],update);
       case {1}
          bfm_plot_brainlv_3v(0,PLSresultFile,grp_idx,lv_idx,1,behav_idx,[],update);
     end
     ...
     switch action 
       case {0}
          bfm_plot_brainlv_3v(2,PLSresultFile,grp_idx,lv_idx,0,behav_idx,[],update);
       case {1}
          bfm_plot_brainlv_3v(2,PLSresultFile,grp_idx,lv_idx,1,behav_idx,[],update);
     end;
