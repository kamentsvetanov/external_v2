function fig = fmri_result_sa_ui(action,varargin)
   ...
   if ~exist('action','var') | ~ischar(action)
      ...
      fmri_result_sa_ui('Rotation', rot_amount);
...
%                  setting3 = setting;
 %                 save(PLSresultFile, '-append', 'setting3');
      ...
      DeleteLinkedFigure;
      calling_fig = getappdata(gcbf,'CallingFigure');
...
%---------------------------------------------------------------------------
%
function h0 = init(PLSResultFile, sa, h0);
   ...
   h0 = figure('Units','normal', ...
   	...
   	'MenuBar','none',...
   	'Position',pos, ...
   	'DeleteFcn','fmri_result_sa_ui(''DeleteFigure'')', ...
   	'Tag','PlotBrainLV');
   %
...
%	'foregroundcolor',[1 0 0], ...
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','fmri_result_sa_ui(''EditLV'')', ...
   	'Tag','LVIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Style','edit', ...
   	'Tag','FirstSlice');
%   	'Callback','fmri_result_sa_ui(''EditFirstSlice'')', ...
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Style','edit', ...
   	'Tag','SliceStep');
%   	'Callback','fmri_result_sa_ui(''EditStep'')', ...
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Style','edit', ...
   	'Tag','LastSlice');
%   	'Callback','fmri_result_sa_ui(''EditLastSlice'')', ...
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','fmri_result_sa_ui(''EditThresh'')', ...
   	'Tag','Threshold');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','fmri_result_sa_ui(''EditMax'')', ...
   	'Tag','MaxValue');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','fmri_result_sa_ui(''EditMin'')', ...
   	'Tag','MinValue');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'Tooltip','Default set to 95 percentile of Bootstrap ratio', ...
   	'Style','edit', ...
   	'Callback','fmri_result_sa_ui(''UpdatePValue'')', ...
   	'Tag','BSThreshold');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'ToolTipString','Click to select the XYZ you entered', ...
   	'Style','push', ...
   	'Callback','fmri_result_sa_ui(''EditXYZ'')');
...
%   	'Style','popupmenu', ...
%   	'Callback','fmri_result_sa_ui(''XYZmmLabel'')', ...
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'ToolTipString','Voxel coordinates w.r.t. the origin', ...
   	'Style','edit', ...
   	'Callback','fmri_result_sa_ui(''EditXYZmm'')', ...
   	'Tag','XYZmm');
   ...
   h1 = uicontrol('Parent',h0, ...
   	'Units','normal', ...
   	'Callback','fmri_result_sa_ui(''PlotBnPress'')', ...
	'fontunit','normal', ...
   	'FontSize',fnt, ...
   	'ListboxTop',0, ...
   	'Position',pos, ...
...
%        'Callback','fmri_result_sa_ui(''CloseFigure'');', ...
   ...
   h1 = uicontrol('Parent',h0, ...			% rescale button
	...
	'Value', 0, ...
	'Visible','Off', ...
   	'Callback','fmri_result_sa_ui(''RescaleBnPress'')', ...
   	'Tag','RESCALECheckbox');
   ...
   h2 = uimenu(h_file, ...
   	   ...
   	   'Tag','LoadBGImage', ...
           'Callback','fmri_result_sa_ui(''LoadBackgroundImage'')'); 
   h2 = uimenu(h_file, ...
           'Label','Save brain region to IMG file', ...
   	   'Tag','SaveBGImage', ...
           'Callback','fmri_result_sa_ui(''SaveBackgroundImage'')'); 
   h2 = uimenu(h_file, ...
           'Label','&Load PLS Result', ...
   	   'Tag','LoadPLSResult', ...
		'visible', 'off', ...
           'Callback','fmri_result_sa_ui(''LoadResultFile'')'); 
   h2 = uimenu(h_file, ...
           'Label','&Save Current Display to the IMG files', ...
   	   'Tag','SaveDisplayToIMG', ...
           'Callback','fmri_result_sa_ui(''SaveDisplayToIMG'')'); 
   h2 = uimenu(h_file, ...
           'Label','&Save BLV to the IMG files', ...
   	   'Tag','SaveResultToIMG', ...
           'Callback','fmri_result_sa_ui(''SaveResultToIMG'')'); 
   ...
   h2 = uimenu('Parent',h0, ...
   	   'Label','&Zoom on', ...
	   'Userdata', 1, ...
           'Callback','fmri_result_sa_ui(''Zooming'')', ...
   	   'Tag','ZoomToggleMenu');
   ...
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&none', ...
   	   'Checked','on', ...
           'Callback','fmri_result_sa_ui(''Rotation'',1)', ...
   	   'Tag','Rotate0Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&90 degree', ...
   	   'Checked','off', ...
           'Callback','fmri_result_sa_ui(''Rotation'',2)', ...
   	   'Tag','Rotate90Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&180 degree', ...
   	   'Checked','off', ...
           'Callback','fmri_result_sa_ui(''Rotation'',3)', ...
   	   'Tag','Rotate180Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&270 degree', ...
   	   'Checked','off', ...
           'Callback','fmri_result_sa_ui(''Rotation'',0)', ...
   	   'Tag','Rotate270Menu');
   ...
   h2 = uimenu('Parent',h_view, ...
   	   ...
   	   'Label','&View Brain LV', ...
	   'Userdata', 1, ...
           'Callback','fmri_result_sa_ui(''Toggle_View'')', ...
   	   'Tag','ViewToggleMenu');
   ...
   h2 = uimenu(h_pls, ...
           'Label','&Singular Values Plot', ...
     	   'Tag','OpenEigenPlot', ...
           'Callback','fmri_result_sa_ui(''OpenEigenPlot'')'); 
   h2 = uimenu(h_pls, ...
   ...
   h2 = uimenu(h_pls, ...
           'Label','&Design Scores and LVs Plot', ...
     	   'Tag','OpenDesignPlot', ...
           'Visible', 'off', ...
           'Callback','fmri_result_sa_ui(''OpenDesignPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','Task PLS Brain Scores with CI', ...
	   'Visible','off', ...
     	   'Tag','OpenTBrainScoresPlot', ...
           'Callback','fmri_result_sa_ui(''OpenTBrainScoresPlot'')');
   h2 = uimenu(h_pls, ...
   ...
   h2 = uimenu(h_pls, ...
           ...
           'Callback','fmri_result_sa_ui(''OpenBrainScoresPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','Temporal Brain Correlation Plot', ...
     	   'Tag','OpenBrainCorrelationPlot', ...
	   'visible','on', ...
           'Callback','fmri_result_sa_ui(''OpenBrainCorrelationPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Response Function Plot', ...
     	   'Tag','OpenRFPlot', ...
           'Callback','fmri_result_sa_ui(''OpenResponseFnPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Datamat Correlations Response', ...
     	   'Tag','OpenRF1Plot', ...
           'Callback','fmri_result_sa_ui(''OpenCorrelationPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Datamat Correlations Plot', ...
     	   'Tag','OpenDatamatcorrsPlot', ...
           'Callback','fmri_result_sa_ui(''OpenDatamatcorrsPlot'')'); 
   h2 = uimenu(h_pls, ...
   ...
   h2 = uimenu(h_pls, ...
           ...
           'Callback','fmri_result_sa_ui(''OpenContrastWindow'')'); 
   h2 = uimenu(h_pls, ...
           'Label','Create Brain LV &Figure', ...
	   'separator', 'on', ...
   	   'Tag','PlotNewFigure', ...
           'Callback','fmri_result_sa_ui(''PlotOnNewFigure'')'); 
   h2 = uimenu(h_pls, ...
   ...
   h2 = uimenu(h_pls, ...
           ...
           'Callback','fmri_result_sa_ui(''SetClusterReportOptions'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Load Cluster Report', ...
     	   'Tag','LoadClsuterReport', ...
           'Callback','fmri_result_sa_ui(''LoadClusterReport'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Create Cluster Report', ...
     	   'Tag','OpenClusterReport', ...
           'Callback','fmri_result_sa_ui(''OpenClusterReport'')'); 
   h2 = uimenu(h_pls, ...
           'Label','Cluster Mask', ...
	   'separator', 'on', ...
           'check', 'off', ...
	   'Userdata', 1, ...
   	   'Tag','ClusterMask', ...
           'Callback','fmri_result_sa_ui(''ClusterMask'')'); 
...
function rot_amount = load_pls_result()
   ...
   if sa
      ...
      st_voxel_size_sa = st_voxel_size([2,3,1]);
      st_origin_sa = st_origin([2,3,1]);
   else
      st_dims_sa = st_dims([1,4,3,2]);
      st_voxel_size_sa = st_voxel_size([1,3,2]);
      st_origin_sa = st_origin([1,3,2]);
   end

   num_slices = st_dims_sa(4);
   if (num_slices > 10)
 ...
 %    fmri_plot_cluster_mask(cluster_info);
  ...
  if (getappdata(gcf,'ViewBootstrapRatio') == 0),	% plot brain lv 
	...
	return;
     ...
     switch action 
       case {0}
          plot_st_brainlv(PLSresultFile,lv_idx,slice_idx,thresh,thresh2,range,0,sa,cluster_info,update);
       case {1}
          plot_st_brainlv(PLSresultFile,lv_idx,slice_idx,thresh,thresh2,range,1,sa,cluster_info,update);
     end;
	...
	return;
     ...
     switch action 
       case {0}
          plot_bs_ratio(PLSresultFile,lv_idx,slice_idx,thresh_ratio,thresh_ratio2,range,0,sa,cluster_info,update);
       case {1}
          plot_bs_ratio(PLSresultFile,lv_idx,slice_idx,thresh_ratio,thresh_ratio2,range,1,sa,cluster_info,update);
     end;
...
%-------------------------------------------------------------------------
%   
function plot_st_brainlv(PLSresultFile,lv_idx,slice_idx,thresh,thresh2,range,new_fig,sa,cluster_info,update)
% 
...
if 0
  ...
  if (mod(rot_amount,2) == 0) 
    img_height = st_dims_sa(1);		  % rows 
    img_width  = st_dims_sa(2);
  else
    img_height = st_dims_sa(2);		  % rows - after 90 or 270 rotation
    img_width  = st_dims_sa(1);
  end;
  ...
  for i=1:win_size,
     ...
     [img,cmap,cbar] = fmri_plot_brainlv_sa(blv,st_coords,st_dims,slice_idx, ...
		thresh,thresh2,range,rot_amount,bg_img,sa,st_dims_sa,cluster_idx);
  ...
  set(h_img,'ButtonDownFcn','fmri_result_sa_ui(''SelectPixel'')');
  create_colorbar( colorbar_hdl, cbar, min_blv, max_blv );
  ...
  %
  setappdata(gcf,'STDims',st_dims);
  setappdata(gcf,'STVoxelSize',st_voxel_size_sa);
  setappdata(gcf,'STOrigin',st_origin_sa);
...
%-------------------------------------------------------------------------
%   
function plot_bs_ratio(PLSresultFile,lv_idx,slice_idx,thresh,thresh2,range,new_fig,sa,cluster_info,update)
% 
  if (new_fig)
     bg_img = getappdata(gcbf,'BackgroundImg');
     rot_amount = getappdata(gcbf,'RotateAmount');
...
%     if (abs(min_ratio) > abs(max_ratio)),
 %      max_ratio = abs(min_ratio);
  ...
  for i=1:win_size,
     ...
     [img,cmap,cbar] = fmri_plot_brainlv_sa(bsr,st_coords,st_dims,slice_idx, ...
		thresh,thresh2,range,rot_amount,bg_img,sa,st_dims_sa,cluster_idx);
...
function SelectPixel()
   ...
   slice_num = slice_idx(col);		% mean x for sa
   ...
   coord_z = st_dims(4) - cur_y + 1;
   coord = (coord_z-1)*st_dims(1)*st_dims(2) + (coord_y-1)*st_dims(1) + coord_x;
...
%   if getappdata(gcbf,'isbehav')
 %     figure(linkfig); fmri_plot_corr('NewCoord',coord,xyz);
  % else
   %   figure(linkfig); fmri_plot_rf('NewCoord',coord,xyz);
   %end
end
...
function [axes_h,colorbar_h] = create_new_blv_figure();
   ...
   fig_h = figure('Units','normal', ...
   	...
   	'DoubleBuffer','on', ...
   	'Position',pos, ...
   	'DeleteFcn','fmri_result_sa_ui(''DeleteNewFigure'')', ...
	'InvertHardcopy','off', ...
