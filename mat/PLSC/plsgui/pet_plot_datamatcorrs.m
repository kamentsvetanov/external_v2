%pet_plot_datamatcorrs Display the PLS analysis results
%
%   Usage: fig = pet_plot_datamatcorrs(action,varargin)
%
%   see also pet_plot_datamatcorrs
%
...
function fig = pet_plot_datamatcorrs(action,varargin)
...
%      set(gcbf,'visible','on');
      ...
      pet_plot_datamatcorrs('Rotation', rot_amount);
   ...
   elseif (strcmp(action,'DeleteNewFigure'))
      try
         ...
         pet_plot_datamatcorrs_newfig_pos = get(gcbf,'position');

         save(pls_profile, '-append', 'pet_plot_datamatcorrs_newfig_pos');
      catch
      end
   elseif (strcmp(action,'DeleteFigure'))
     try
        ...
        pet_plot_datamatcorrs_pos = get(gcbf,'position');

        save(pls_profile, '-append', 'pet_plot_datamatcorrs_pos');
     catch
     end
...
function h0 = init(PLSResultFile);
   ...
   if ~isempty(pet_plot_datamatcorrs_pos) & strcmp(save_setting_status,'on')

      pos = pet_plot_datamatcorrs_pos;
...
%   [r_path,r_file,r_ext] = fileparts(PLSResultFile);
   ...
   h0 = figure('Units','normal', ...
   	...
   	'MenuBar','none',...
   	'Position',pos, ...
   	'DeleteFcn','pet_plot_datamatcorrs(''DeleteFigure'')', ...
   	'Tag','PlotBrainLV');
   %
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','pet_plot_datamatcorrs(''EditGroup'')', ...
   	'Tag','GroupIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...			% lv index edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','pet_plot_datamatcorrs(''EditLV'')', ...
   	'Tag','LVIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...			% behav index edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','pet_plot_datamatcorrs(''EditBehav'')', ...
   	'Tag','BehavIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...			% lv index edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','pet_plot_datamatcorrs(''EditBSLV'')', ...
   	'Tag','BSLVIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','pet_plot_datamatcorrs(''UpdatePValue'')', ...
   	'Tag','BSThreshold');
...
%
  ...
  if (getappdata(gcf,'ViewBootstrapRatio') == 0),	% plot brain lv
     ...
     switch action
       case {0}
          pet_plot_brainlv(0,PLSresultFile,grp_idx,lv_idx,0,behav_idx,[],update);
       case {1}
          pet_plot_brainlv(0,PLSresultFile,grp_idx,lv_idx,1,behav_idx,[],update);
     end
     ...
     switch action
       case {0}
          pet_plot_brainlv(2,PLSresultFile,grp_idx,lv_idx,0,behav_idx,[],update);
       case {1}
          pet_plot_brainlv(2,PLSresultFile,grp_idx,lv_idx,1,behav_idx,[],update);
     end;
...
function orient
   ...
   pet_plot_datamatcorrs('Rotation',1);
