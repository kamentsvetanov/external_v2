function fig = struct_result_sa_ui(action,varargin)
   ...
   if ~exist('action','var') | ~ischar(action)
      ...
      struct_result_sa_ui('Rotation', rot_amount);
...
function h0 = init(PLSResultFile, sa)
   ...
   h0 = figure('Units','normal', ...
   	...
   	'MenuBar','none',...
   	'Position',pos, ...
   	'DeleteFcn','struct_result_sa_ui(''DeleteFigure'')', ...
   	'Tag','PlotBrainLV');
   %
   ...
   h1 = uicontrol('Parent',h0, ...			% lv index edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','struct_result_sa_ui(''EditLV'')', ...
   	'Tag','LVIndexEdit');
   ...
   h1 = uicontrol('Parent',h0, ...			% threshold edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','struct_result_sa_ui(''EditThresh'')', ...
   	'Tag','Threshold');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   h1 = uicontrol('Parent',h0, ...			% max value edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','struct_result_sa_ui(''EditMax'')', ...
   	'Tag','MaxValue');
   ...
   h1 = uicontrol('Parent',h0, ...			% min value edit
	...
	'fontunit','normal', ...
   	...
   	'Position',pos, ...
   	'Style','edit', ...
   	'Callback','struct_result_sa_ui(''EditMin'')', ...
   	'Tag','MinValue');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'Tooltip','Default set to 95 percentile of Bootstrap ratio', ...
   	'Style','edit', ...
   	'Callback','struct_result_sa_ui(''UpdatePValue'')', ...
   	'Tag','BSThreshold');
   ...
   h1 = uicontrol('Parent',h0, ...
	...
	'ToolTipString','Click to select the XYZ you entered', ...
   	'Style','push', ...
   	'Callback','struct_result_sa_ui(''EditXYZ'')');
...
%   	'Style','popupmenu', ...
%   	'Callback','struct_result_sa_ui(''XYZmmLabel'')', ...
   ...
   h1 = uicontrol('Parent',h0, ...			% Origin text
	...
	'ToolTipString','Voxel coordinates w.r.t. the origin', ...
   	'Style','edit', ...
   	'Callback','struct_result_sa_ui(''EditXYZmm'')', ...
   	'Tag','XYZmm');
   ...
   h1 = uicontrol('Parent',h0, ...			% rescale button
	...
	'Value',1, ...
	'Visible','off', ...
	'Callback','struct_result_sa_ui(''RescaleBnPress'')', ...
   	'Tag','RESCALECheckbox');
...
%   	'Units','pixels', ...
%   	'Callback','struct_result_sa_ui(''PlotBnPress'')', ...
%   	'FontSize',10, ...
%   	'ListboxTop',0, ...
...
%        'Callback','struct_result_sa_ui(''CloseFigure'');', ...
   ...
   h2 = uimenu(h_file, ...
		...
		'visible','off', ...
           'Callback','struct_result_sa_ui(''LoadTemplateFile'')');

   h2 = uimenu(h_file, ...
           'Label','&Load Background Image', ...
           'Tag','LoadBGImage', ...
           'Callback','struct_result_sa_ui(''LoadBackgroundImage'')');
   h2 = uimenu(h_file, ...
           'Label','Save brain region to IMG file', ...
   	   'Tag','SaveBGImage', ...
           'Callback','struct_result_sa_ui(''SaveBackgroundImage'')'); 
   h2 = uimenu(h_file, ...
           'Label','&Load PLS Result', ...
   	   'Tag','LoadSTRUCTResult', ...
		'visible', 'off', ...
           'Callback','struct_result_sa_ui(''LoadResultFile'')');
   h2 = uimenu(h_file, ...
           'Label','&Save Current Display to the IMG files', ...
   	   'Tag','SaveDisplayToIMG', ...
           'Callback','struct_result_sa_ui(''SaveDisplayToIMG'')'); 
   h2 = uimenu(h_file, ...
           'Label','&Save BLV to the IMG files', ...
   	   'Tag','SaveResultToIMG', ...
           'Callback','struct_result_sa_ui(''SaveResultToIMG'')');
   ...
   h2 = uimenu('Parent',h0, ...
   	   'Label','&Zoom on', ...
	   'Userdata', 1, ...
           'Callback','struct_result_sa_ui(''Zooming'')', ...
   	   'Tag','ZoomToggleMenu');
   ...
   h2 = uimenu('Parent',h_rot, ...
   	   ...
   	   'Checked','on', ...
           'Callback','struct_result_sa_ui(''Rotation'',1)', ...
   	   'Tag','Rotate0Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&90 degree', ...		% another 90 degree
   	   'Checked','off', ...
           'Callback','struct_result_sa_ui(''Rotation'',2)', ...
   	   'Tag','Rotate90Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&180 degree', ...		% now become 270 degree
   	   'Checked','off', ...
           'Callback','struct_result_sa_ui(''Rotation'',3)', ...
   	   'Tag','Rotate180Menu');
   h2 = uimenu('Parent',h_rot, ...
   	   'Label','&270 degree', ...		% now completed 360 degree
   	   'Checked','off', ...
           'Callback','struct_result_sa_ui(''Rotation'',0)', ...
   	   'Tag','Rotate270Menu');
   ...
   h2 = uimenu('Parent',h_view, ...
   	   'Label','&View Brain LV', ...
	   'Userdata', 1, ...
           'Callback','struct_result_sa_ui(''Toggle_View'')', ...
   	   'Tag','ViewToggleMenu');
   ...
   h2 = uimenu(h_pls, ...
           'Label','&Singular Values Plot', ...
     	   'Tag','OpenEigenPlot', ...
           'Callback','struct_result_sa_ui(''OpenEigenPlot'')');
   h2 = uimenu(h_pls, ...
           'Label','&Behavior LV and Behavior Scores Plot', ...
	   'Visible','off', ...
     	   'Tag','OpenBehavPlot', ...
           'Callback','struct_result_sa_ui(''OpenScoresPlot'',0)');
   h2 = uimenu(h_pls, ...
           'Label','&Design LV and Design Scores Plot', ...
	   'Visible','off', ...
     	   'Tag','OpenDesignPlot', ...
           'Callback','struct_result_sa_ui(''OpenScoresPlot'',1)');
   h2 = uimenu(h_pls, ...
           'Label','Task PLS Brain Scores with CI', ...
	   'Visible','off', ...
     	   'Tag','OpenBrainScoresPlot', ...
           'Callback','struct_result_sa_ui(''OpenBrainScoresPlot'')');
   h2 = uimenu(h_pls, ...
           'Label','B&rain Scores vs. Behavior Data Plot', ...
     	   'Tag','OpenBrainPlot', ...
           'Callback','struct_result_sa_ui(''OpenBrainPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Voxel Intensity Response', ...
     	   'Tag','OpenRFPlot', ...
           'Callback','struct_result_sa_ui(''OpenResponseFnPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Datamat Correlations Response', ...
     	   'Tag','OpenRF1Plot', ...
           'Callback','struct_result_sa_ui(''OpenCorrelationPlot'')'); 
   h2 = uimenu(h_pls, ...
           'Label','&Datamat Correlations Plot', ...
     	   'Tag','OpenDatamatcorrsPlot', ...
           'Callback','struct_result_sa_ui(''OpenDatamatcorrsPlot'')'); 
   h2 = uimenu(h_pls, ...
   ...
   h2 = uimenu(h_pls, ...
           ...
           'Callback','struct_result_sa_ui(''OpenContrastWindow'')'); 
   h2 = uimenu(h_pls, ...
           'Label','Create Brain LV &Figure', ...
	   'separator', 'on', ...
   	   'Tag','PlotNewFigure', ...
           'Callback','struct_result_sa_ui(''PlotOnNewFigure'')');
   h2 = uimenu(h_pls, ...
   ...
   h2 = uimenu(h_pls, ...
           ...
           'Callback','struct_result_sa_ui(''SetClusterReportOptions'')');
   h2 = uimenu(h_pls, ...
           'Label','&Load Cluster Report', ...
     	   'Tag','LoadClsuterReport', ...
           'Callback','struct_result_sa_ui(''LoadClusterReport'')');
   h2 = uimenu(h_pls, ...
           'Label','&Create Cluster Report', ...
     	   'Tag','OpenClusterReport', ...
           'Callback','struct_result_sa_ui(''OpenClusterReport'')');
   h2 = uimenu(h_pls, ...
           'Label','Cluster Mask', ...
	   'separator', 'on', ...
           'check', 'off', ...
	   'Userdata', 1, ...
   	   'Tag','ClusterMask', ...
           'Callback','struct_result_sa_ui(''ClusterMask'')'); 
 ...
 %    struct_plot_cluster_mask(cluster_info);
  ...
  if (getappdata(gcf,'ViewBootstrapRatio') == 0),	% plot brain lv
	...
	return;
     ...
     switch action
       case {0}
          pet_plot_brainlv_sa(0,PLSresultFile,0,lv_idx,0,[],sa,cluster_info,update,1);
       case {1}
          pet_plot_brainlv_sa(0,PLSresultFile,0,lv_idx,1,[],sa,cluster_info,update,1);
     end
	...
	return;
     ...
     switch action
       case {0}
          pet_plot_brainlv_sa(1,PLSresultFile,0,lv_idx,0,[],sa,cluster_info,update,1);
       case {1}
          pet_plot_brainlv_sa(1,PLSresultFile,0,lv_idx,1,[],sa,cluster_info,update,1);
     end;
...
%         cur_x = img_width - slice_x + 1;
   ...
   coord_z = dims(4) - cur_y + 1;
   coord = (coord_z-1)*dims(1)*dims(2) + ...
	(coord_y-1)*dims(1) + coord_x;
...
%      if get(findobj(gcf, 'tag', 'XYZmmLabel'), 'value') == 2
 %        if sa
  %          xyz_mm = mni2tal(xyz_mm([3 1 2]));
   %         xyz_mm = xyz_mm([2 3 1]);
    %     else
     %       xyz_mm = mni2tal(xyz_mm([1 3 2]));
      %      xyz_mm = xyz_mm([1 3 2]);
       %  end
      %end
...
%      if sa
 %        xyz_mm = tal2mni(xyz_mm([3 1 2]));
  %       xyz_mm = xyz_mm([2 3 1]);
   %   else
    %     xyz_mm = tal2mni(xyz_mm([1 3 2]));
     %    xyz_mm = xyz_mm([1 3 2]);
      %end
   %end
