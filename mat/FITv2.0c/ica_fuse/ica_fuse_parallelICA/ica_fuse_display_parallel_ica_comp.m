...
if numAxes == 2
    ...
    featureOb = dataStruct.feature;
    
    dataStruct.feature = featureOb;
    clear featureOb;
    
    legendString{length(legendString) + 1} = dataStruct.feature(1).feature_name;
    legendString{length(legendString) + 1} = dataStruct.feature(2).feature_name;
    colors = {'.-g', '.-r'};
    
end

legendString = cellstr(str2mat(dataStruct.feature.feature_name));
