...
try
    ...
    if (~exist('fusionFile', 'var'))
        ...
        fusionFile = ica_fuse_selectEntry('typeEntity', 'file', 'typeSelection', 'single', 'filter', ...
            ['*', FUSION_INFO_MAT_FILE, '*.mat'], 'title', 'Select fusion information file for running joint ICA analysis');
        drawnow;
    end
