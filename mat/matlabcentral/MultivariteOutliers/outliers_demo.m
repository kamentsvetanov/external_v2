...
% Note that the function atomically plots robust Mahalanobis distance (RD)
...
% To improve detection accuracy you can also supply an estimate of
% the number of outliers in X (n_out) as [...]=DetectMultVarOutliers(X,n_out)
