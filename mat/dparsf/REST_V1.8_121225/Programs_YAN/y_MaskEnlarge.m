function y_MaskEnlarge(Maskfilename,OutMaskFileName,dilate_degree)
% FORMAT y_MaskEnlarge(Maskfilename,OutMaskFileName,dilate_degree)
%   Input:
%     Maskfilename - The mask file want to be enlarged
%     OutMaskFileName - The enlarged mask output
%     dilate_degree - How many voxels to be enlarged. E.g., 2 means shrink 2 voxels
%   Output:
%     OutMaskFileName - The enlarged mask output
...
BinaryMaskTemp=logical(Mask_img); %set voxels within mask to 1, and enlarge "dilate_degree" voxel
