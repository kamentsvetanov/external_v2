...
mu          = zeros(1,d); % We want demeaned signal sources
id_mat      = ones(d);
idx         = logical(triu(id_mat,d)-triu(id_mat,d+1));
Sigma       = diag(lambdas); % Set the variance of each component on the diagonal
data = mvnrnd(mu,Sigma,d);
