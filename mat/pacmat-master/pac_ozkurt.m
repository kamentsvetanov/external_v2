% pac_ozkurt() -  calculate phase-amplitude coupling (PAC) using a
%     modulation index method (see Ozkurt & Schnitzler, 2011)
%
% Usage:
%     >> pac = pac_ozkurt(lo, hi, f_lo, f_hi, fs);
%
% Inputs:
...
%     >> pac_ozkurt(lo, hi, [4,8], [80,150], 1000) % Calculate PAC
%     ans =
%         0.4803
%
