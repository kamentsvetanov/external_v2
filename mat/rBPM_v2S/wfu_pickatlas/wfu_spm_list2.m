function varargout = wfu_spm_list2(varargin)
% Display and analysis of SPM{.}
% FORMAT TabDat = wfu_spm_list2('List',SPM,hReg,[Num,Dis,Str])
% Summary list of local maxima for entire volume of interest
% FORMAT TabDat = wfu_spm_list2('ListCluster',SPM,hReg,[Num,Dis,Str])
...
%                           ----------------
%
% FORMAT wfu_spm_list2('TxtList',TabDat,c)
...
%                           ----------------
%
% FORMAT wfu_spm_list2('SetCoords',xyz,hAx,hC)
...
%
% wfu_spm_list2 characterizes SPMs (thresholded at u and k) in terms of
...
%=======================================================================
% FORMAT TabDat = wfu_spm_list2('list',SPM,hReg)
...
uimenu(h,'Separator','on','Label','Print text table',...
	'Tag','TD_TxtTab',...
	'CallBack',...
	'wfu_spm_list2(''txtlist'',get(get(gcbo,''Parent''),''UserData''),3)',...
	'Interruptible','off','BusyAction','Cancel');
...
uimenu(h,'Separator','on','Label','help',...
	'Tag','TD_Xdat',...
	'CallBack','spm_help(''wfu_spm_list2'')',...
	'Interruptible','off','BusyAction','Cancel');

%-Setup registry
%-----------------------------------------------------------------------
set(hAx,'UserData',struct('hReg',hReg,'HlistXYZ',HlistXYZ))
spm_XYZreg('Add2Reg',hReg,hAx,'wfu_spm_list2');
...
%=======================================================================
% FORMAT TabDat = wfu_spm_list2('listcluster',SPM,hReg)
...
%-----------------------------------------------------------------------
varargout = {wfu_spm_list2('list',SPM,hReg,Num,Dis)};
...
%=======================================================================
% FORMAT wfu_spm_list2('SetCoords',xyz,hAx,hReg)
